...
$string['configproxybypass'] = 'قائمة بأسماء المضيفين (جزئياً) أو عناوين IP التي يجب عليها تجاوز الوكيل.
إفصل ما بين العناصر بفوارز إنجليزية، بدون فراغات. على سبيل المثال:
192.168.0.0/16،*.mydomain.com.';
