...
$string['configallowcohortthemes'] = 'إذا قمت بتمكين هذا، فيمكن تعيين المظهر على مستوى الدفعة. سيؤثر هذا على جميع المستخدمين في دفعة واحدة فقط أو أكثر من واحد ولكن مع نفس المظهر.';
$string['configallowcoursethemes'] = 'عند تمكينه، سيُسمح للمقررات الدراسية باختيار المظاهر الخاصة بها. مظاهر المقررات الدراسية تتجاوز كل خيارات المظهر الأخرى (الموقع، المستخدم، التصنيف، الدفعة أو المظاهر المعرفة حسب عنوان الرابط).';
