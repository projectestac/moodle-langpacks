...
/**
 * Strings for component 'assign', language 'ar', branch 'MOODLE_38_STABLE'
 *
 * @package   assign
...
$string['activityoverview'] = 'لديك مهام تتطلب الانتباه';
...
$string['applytoteam'] = 'تطبيق العلامات والإفادات على المجموعة بأكملها';
...
$string['assign:managegrades'] = 'مراجعة وإطلاق العلامات';
...
$string['assignmentsperpage'] = 'عدد المهام في الصفحة الواحدة';
$string['assign:receivegradernotifications'] = 'تلقي إخطارات عند تصحيح التسليمات';
$string['assign:releasegrades'] = 'إطلاق العلامات';
$string['assign:revealidentities'] = 'الكشف عن هوية الطالب';
$string['assign:reviewgrades'] = 'مراجعة العلامات';
...
$string['defaultsettings_help'] = 'هذه الإعدادات تحدد إفتراضيات كل المهام الجديدة.';
...
$string['eventallsubmissionsdownloaded'] = 'يجري تنزيل كل التسليمات.';
$string['eventassessablesubmitted'] = 'تم تقديم تسليم.';
$string['eventbatchsetmarkerallocationviewed'] = 'تمت معاينة تعيين التصحيح بالجملة.';
$string['eventbatchsetworkflowstateviewed'] = 'تمت معاينة تحديد حالة سير العمل بالجملة.';
$string['eventextensiongranted'] = 'تم منح تمديد.';
$string['eventfeedbackupdated'] = 'تم تحديث الإفادة';
$string['eventfeedbackviewed'] = 'تمت معاينة الإفادة';
$string['eventgradingformviewed'] = 'تمت معاينة نموذج التقييم';
$string['eventgradingtableviewed'] = 'تمت معاينة جدول التقييم';
$string['eventidentitiesrevealed'] = 'تم كشف الهويات.';
$string['eventmarkerupdated'] = 'تم تحديث المصحح المعيَّن.';
$string['eventoverridecreated'] = 'تم إنشاء تجاوز الواجب';
$string['eventoverridedeleted'] = 'تم حذف تجاوز الواجب';
$string['eventoverrideupdated'] = 'تم تحديث تجاوز الواجب';
$string['eventremovesubmissionformviewed'] = 'تمت معاينة تأكيد إزالة التسليم.';
$string['eventrevealidentitiesconfirmationpageviewed'] = 'تمت معاينة صفحة تأكيد كشف الهويات.';
$string['eventstatementaccepted'] = 'وافق المستخدم على بيان التسليم.';
$string['eventsubmissionconfirmationformviewed'] = 'تمت معاينة نموذج تأكيد التسليم.';
$string['eventsubmissioncreated'] = 'تم إنشاء تسليم.';
$string['eventsubmissionduplicated'] = 'قام المستخدم بتكرار تسليمه.';
$string['eventsubmissionformviewed'] = 'تمت معاينة نموذج التسليم.';
$string['eventsubmissiongraded'] = 'تم تقييم التسليم.';
$string['eventsubmissionlocked'] = 'تم قفل التسليمات لمستخدم.';
$string['eventsubmissionstatusupdated'] = 'تم تحديث حالة التسليم.';
$string['eventsubmissionstatusviewed'] = 'تمت معاينة حالة التسليم.';
$string['eventsubmissionunlocked'] = 'تم إلغاء قفل التسليمات لمستخدم.';
$string['eventsubmissionupdated'] = 'تم تحديث التسليم.';
$string['eventsubmissionviewed'] = 'تمت معاينة التسليم.';
$string['eventworkflowstateupdated'] = 'تم تحديث حالة سير العمل.';
...
$string['feedbackpluginforgradebook_help'] = 'يمكن لملحق إفادة مهام واحد فقط أن يضع الإفادات في سجل العلامات.';
...
$string['maxperpage'] = 'أقصى عدد من المهام في الصفحة';
$string['maxperpage_help'] = 'أقصى عدد من المهام التي يمكن للمُقيِّم إظهارها في صفحة تقييم المهام. هذا الإعداد مفيد في منع استنفاذ مهلة الجلسة للمساقات ذات الأعداد الكبيرة من المشاركين.';
$string['messageprovider:assign_notification'] = 'إشعارات الواجب';
$string['modulename'] = 'واجب';
$string['modulename_help'] = 'تُمكن وحدة نشاط الواجب المعلم من إيصال الواجبات، جمع التسليمات ووضع العلامات والإفادات.
...
عند استعراض الواجبات، يمكن للمعلمين ترك تعليقات الإفادات ورفع الملفات، مثل تسليمات الطلاب المصححة، وثائق ذات تعليقات أو إفادات صوتية. يمكن وضع علامات الواجبات باستعمال مقياس عددي أو مخصص، أو طريقة متقدمة لمنح العلامات مثل سلم التقييم. العلامات النهائية تذهب إلى سجل العلامات.';
...
$string['privacy:metadata:assignperpage'] = 'عدد المهام المعروضة في الصفحة.';
...
$string['privacy:metadata:assignuserflags'] = 'يخزن البيانات الوصفية للمستخدم مثل تواريخ التمديد';
...
$string['submittedlate'] = 'تم تسليم الواجب متأخراً بـ {$a}';
...
$string['viewgradebook'] = 'معاينة سجل العلامات';
