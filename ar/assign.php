...
عند استعراض الواجبات، يمكن للمعلمين ترك تعليقات الإفادات ورفع الملفات، مثل تسليمات الطلاب المصححة، وثائق ذات تعليقات أو إفادات صوتية. يمكن وضع علامات الواجبات باستعمال مقياس عددي أو مخصص، أو طريقة متقدمة لمنح العلامات مثل سلم التقييم. التقديرات النهائية تذهب إلى سجل التقديرات.';
