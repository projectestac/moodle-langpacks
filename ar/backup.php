...
$string['backupdetailsnonstandardinfo'] = 'الملف المُحدَّد ليس بالشكل المعياري المقبول لملف حفظ إحتياطي لمودل. ستحاول عملية الاستعادة تحويل الملف إلى الشكل المعياري للحفظ الاحتياطي ومن ثم استعادته.';
...
$string['importfile'] = 'استيراد ملف النسخة الاحتياطية';
