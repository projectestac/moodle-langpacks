...
الموقعَ النهائيَ للكتلة سيتم حسابه مع باقي الكُتَل في ذلك النطاق (على سبيل المثال ، كتلة واحدة فقط  يُمْكِنُ أَنْ تَكُونَ في الأعلى ) .
يُمكن أَنْ تتجاوزَ هذه القيمة على الصفحات المعيّنة إذا كان هذا مطلوباً .';
