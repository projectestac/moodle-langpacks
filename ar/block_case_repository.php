...
$string['config_description_yellow_markup'] = 'هذه القيمة (ما بين 0.0 و 1.0، الافتراضي 0.6) تحدد متى يتم تقديم النشاطات البديلة (ذات علامات المَعين الأصفر) إلى المتعلمين.<br/>قيمة 0.6 تعني على سبيل المثال، بأن الحالة الحالية ينبغي أن يكون لها تشابه بنسبة 60 بالمئة (أو أكثر) مع مرجع الحالة المكتشفة ليتم تقديمه بمثابة نشاط بديل.';
