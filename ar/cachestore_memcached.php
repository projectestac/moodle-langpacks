...
$string['privacy:metadata:memcached'] = 'يخزن ملحق مخزن خبأ الذاكرة؛ البيانات لفترة وجيزة كجزء من وظائف التخزين المؤقت. يتم تخزين هذه البيانات على خادم Memcache حيث تتم إزالة البيانات بانتظام.';
$string['privacy:metadata:memcached:data'] = 'البيانات المختلفة المخزنة في الخبأ';
...
$string['testservers_desc'] = 'واحد أو أكثر من جُمل الاتصال بمخدمات خبأ الذاكرة من أجل الفحص بها. إذا تم تحديد مخدم الفحص، سيكون بالإمكان فحص أداء مخبوءات الذاكرة باستعمال صفحة أداء الخبأ في كتلة الإدارة.
