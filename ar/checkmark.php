...
$string['autograde_notsupported'] = 'هذا المقياس غير مدعوم من قبل منح العلامات التلقائي.';
...
$string['flexiblenaming_help'] = 'إذا تم تفعيله، سيتم استعمال الأسماء والعلامات الفردية لكل مثال.';
...
$string['presentationgrading_help'] = 'إذا تم تفعيله، يمكن تسجيل علامات العرض التقديمي بمثابة عناصر إضافية لمعلومات التقييم.';
