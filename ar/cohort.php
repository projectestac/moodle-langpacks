...
$string['removeuserwarning'] = 'إزالة المستخدمين من الفوج قد يؤدي إلى إلغاء انضمامات المستخدمين في مقررات متعددة وهذا الأمر يتضمن حذف إعداداتهم، علاماتهم، عضوياتهم في المجموعات وغيرها من معلومات المستخدمين في المقررات الدراسية المتأثرة بتلك الإزالة.';
$string['search'] = 'بحث';
