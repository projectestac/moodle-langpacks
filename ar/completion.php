...
$string['completionenabled'] = 'ممكن ، يتم ضبطه من إعدادات النشاط و الإكمال';
...
$string['completionusegrade_help'] = 'عند التمكين ، يعتبر النشاط مكتملاً عندما يحصل الطالب على الدرجة . و تظهر أيقونات النجاح و الرسوب إذا تم إعداد درجة نجاح للنشاط .';
...
$string['unlockcompletiondelete'] = 'فتح خيارات الإكمال و حذف بيانات إكمال المستخدم';
