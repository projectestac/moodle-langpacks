...
$string['gradesync'] = 'مزامنة العلامات';
$string['gradesync_help'] = 'فيما إذا كانت العلامات من الأداة سيتم إرسالها إلى النظام البعيد (مستهلك LTI).';
...
$string['requirecompletion'] = 'يتطلب الأمر إكمال المقرر الدراسي أو النشاط قبل مزامنة العلامات';
...
$string['tasksyncgrades'] = 'النشر بمثابة أداة LTI لمزامنة العلامات';
