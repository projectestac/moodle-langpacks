...
$string['aggregationofa'] = 'تجميع تقديرات {$a}';
...
$string['errorupdatinggradecategoryaggregateoutcomes'] = 'وقع خطأ عند تحديث الإعداد "تضمين المخرجات في التجميع" لتصنيف التقديرات ذي المُعرَّف {$a->id}';
$string['errorupdatinggradecategoryaggregation'] = 'وقع خطأ عند تحديث نوعية التجميع لتصنيف التقديرات ذي المُعرَّف {$a->id}';
