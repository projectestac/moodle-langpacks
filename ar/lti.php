...
$string['clientidadmin_help'] = 'يمكن اعتبار معرف العميل كقيمة فريدة تستخدم لتحديد أداة. يتم إنشاؤه تلقائيًا لكل أداة تستخدم ملف تعريف أمان JWT المقدم في LTI 1.3 ويجب أن يكون جزءًا من التفاصيل التي تم تمريرها إلى موفر الأداة حتى يتمكنوا من تكوين الاتصال في نهايتهم.';
...
$string['display_description'] = 'إعرض وصف النشاط عند إطلاقه';
...
$string['lti:admin'] = 'أن يكون مسؤولاً عند إطلاق الأداة';
...
$string['lti:manage'] = 'أن يكون مدرباً عندما يتم إطلاق الأداة';
...
$string['modulename'] = 'الأداة الخارجية';
...
$string['modulenamepluralformatted'] = 'عيِّنات أدوات التعلم المشتركة';
$string['name'] = 'الاسم';
$string['never'] = 'أبدأ';
