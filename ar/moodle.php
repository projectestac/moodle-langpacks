...
$string['availablecourses'] = 'المساقات المتاحة';
$string['back'] = 'العودة';
...
$string['coursehelpnewsitemsnumber'] = 'عدد الإعلانات التي تظهر في كتلة الإعلانات الأخيرة في صفحة المساق. عند جعله صفراً، لن يتم إنشاء منتدى الإعلانات.';
...
$string['frontpagedescriptionhelp'] = 'يمكن عرض هذا الوصف في الصفحة الأمامية للموقع باستعمال كتلة ملخص المساق/الموقع.';
...
$string['includecoursefiles'] = 'تضمين ملفات المساقات';
...
في أغلب برامج البريد سيظهر هذا بشكل رابط أزرق، وما عليك إلا الضغط عليه. إذا لم يعمل ذلك، قم بنسخ العنوان ولصقه في حقل العنوان في متصفح الإنترنت.
