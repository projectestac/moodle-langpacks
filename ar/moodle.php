...
$string['active'] = 'نشط';
$string['activeusers'] = 'مستخدمون نشطون';
...
$string['deselectnos'] = 'ألغ تحديد الكل "لا"';
...
$string['indicator:completeduserprofiledef_help'] = 'تم الاتفاق على سياسات الموقع وقام المستخدم بملء الحقول التالية: المؤسسة ، الإدارة ، العنوان ، المدينة ، البلد ، الرابط.';
...
$string['indicator:potentialsocialdef_help'] = 'الدرجة التي يقدم بها المقرر المشاركة الاجتماعية "واسعة" ، و التفاعل مع المشاركين الآخرين داخل مجتمع الممارسة و خارج الفصل.';
...
$string['previouslyselectedusers'] = 'المستخدمون المختارون سابقاً غير متطابقين \'{$a}\'';
...
$string['resetinfo'] = 'هذه الصفحةِ تَسْمحُ لك بإفراغ المساق من بيانات المستخدمين، في حين تَحتفظُ بالنشاطاتِ والإعدادات الأخرى. رجاءً كُنْ حَذراً، فبمجرد إخْتياَرك للعناصر أدناه والقيام بتسليم هذه الصفحة سيتم حْذفُ بياناتَ المستخدمين التي حددتها نهائياً!';
...
$string['showchartdata'] = 'أظهر بيانات الرسم البياني';
