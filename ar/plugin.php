...
$string['type_cachelock'] = 'معالج قفل الخبأ';
$string['type_cachelock_plural'] = 'معالجات قفل الخبأ';
...
$string['type_filter_plural'] = 'مرشحات النصوص';
...
$string['updatepluginconfirmexternal'] = 'يبدو أن الإصدار الحالي من الملحق قد تم الحصول عليه من خلال نظام إدارة شفرة المصدر ({$a}). إذا قمت بتثبيت هذا التحديث، فلن تتمكن بعد ذلك من الحصول على تحديثات الملحق من مورد نظام إدارة التعليمات البرمجية. الرجاء <strong>التأكد</strong> من أنك بلا شك تريد تحديث المكون الإضافي قبل المتابعة.';
