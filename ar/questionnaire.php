...
/**
 * Strings for component 'questionnaire', language 'ar', version '3.8'.
 *
...
$string['addselqtype'] = 'أضف سؤال بالنوع المحدد';
...
$string['configusergraph'] = 'عرض مخططات  "الاختبار الشخصي" كتغذية راجعة';
$string['configusergraphlong'] = 'استخدم مكتبة Rgraph لعرض مخططات "الاختبار الشخصي" كتغذية راجعة.';
...
$string['confpage_help'] = 'العنوان (بالخط الغامق) و النص الأساسي لصفحة "التأكيد" المعروضة بعد أن يكمل المستخدم هذا الاستبيان.
(الرابط، إذا كان موجودًا ، له الأسبقية على نص التأكيد.) إذا تركت هذا الحقل فارغًا ، فسيتم عرض رسالة افتراضية عند الانتهاء من الاستبيان (شكرًا لك على إكمال هذا الاستبيان).';
$string['confpagedesc'] = 'العنوان (بالخط الغامق) و النص الأساسي لصفحة "التأكيد" المعروضة بعد أن يكمل المستخدم هذا الاستبيان.
...
$string['dependquestion'] = 'سؤال أعلى رتبة';
...
$string['essaybox_help'] = 'سيعرض هذا السؤال مربع نص عادي مع أعمدة مساحة للكتابة x (أو عرض المنطقة) و صفوف مساحة للكتابة y (عدد أسطر النص).
...
$string['feedback_help'] = 'مساعدة عن ردود الفعل';
$string['feedbackaddmorefeedbacks'] = 'أضف {no} المزيد من حقول  ردود الفعل';
$string['feedbackbysection'] = 'أقسام ردود الفعل';
$string['feedbackdefaultlabel'] = '[قسم جديد]';
$string['feedbackeditingglobal'] = 'تحرير ردود الفعل الشاملة عن الاستبيان';
...
$string['feedbackeditmessages'] = 'حفظ إعدادات الأقسام و تعديل رسائل ردود الفعل';
$string['feedbackeditsections'] = 'حفظ الإعدادات وتعديل أقسام ردود الفعل';
$string['feedbackerrorboundaryformat'] = 'يجب أن تكون حدود نقاط ردود الفعل إما مئوية أو رقمًا. لم يتم التعرف على القيمة التي أدخلتها في الحدود {$a}.';
...
$string['feedbackerrorjunkinboundary'] = 'يجب عليك ملء مربعات حدود نقاط ردود الفعل دون ترك أيّ ثغرات.';
$string['feedbackerrorjunkinfeedback'] = 'يجب ملء مربعات التعليقات دون ترك أيّ فجوات.';
$string['feedbackerrororder'] = 'يجب أن تكون حدود نقاط ردود الفعل بالترتيب ، و الأعلى أولاً.
القيمة التي أدخلتها في الحدود {$a} غير متسلسلة.';
$string['feedbackglobal'] = 'ردود الفعل الشاملة';
$string['feedbackglobalheading'] = 'عنوان ردود الفعل الشاملة';
$string['feedbackglobalmessages'] = 'رسائل ردود الفعل الشاملة';
$string['feedbackhdr'] = 'ردود الفعل';
$string['feedbackheading'] = 'عنوان ردود الفعل';
$string['feedbackheading_help'] = 'في حقل عنوان ردود الفعل، يمكنك استخدام متغيرين هما:
 $perpercent و $ oppositescorepercent.';
$string['feedbackmessages'] = 'القسم {$a} رسائل';
$string['feedbacknextsection'] = 'القسم التالي {$a}';
$string['feedbacknone'] = 'لا توجد رسائل ردود الفعل';
$string['feedbacknotes'] = 'ملاحظات ردود الفعل';
$string['feedbacknotes_help'] = 'سيتم عرض النص الذي تم إدخاله هنا على المشاركين في نهاية تقرير ردود الفعل';
...
$string['feedbackremovequestionfromsection'] = 'هذا السؤال جزء من قسم ردود الفعل [{$a}]';
$string['feedbackremovesection'] = 'ستؤدي إزالة هذا السؤال إلى إزالة قسم ردود الفعل تمامًا [{$a}]';
...
$string['feedbackscores_help'] = 'عرض جدول تقديرات ردود الفعل';
$string['feedbacksection'] = 'القسم';
$string['feedbacksectionheading'] = '{$a} عنوان القسم';
$string['feedbacksectionheadingmissing'] = 'يجب إدخال عنوان لقسم ردود الفعل هذا!';
...
$string['missingnameandrequired'] = 'لا يمكن استعمال السؤال {$a} في مقطع الإفادة هذا لأنه ليس له اسم وليس مطلوبًا.';
