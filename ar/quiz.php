...
$string['privacy:metadata:quiz_grades'] = 'تفاصيل عن الدرجة الإجمالية لهذا الاختبار.';
...
$string['returnattempt'] = 'العودة إلى المحاولة';
...
$string['showcategorycontents'] = 'أظهر محتويات التصنيفات {$a->arrow}';
