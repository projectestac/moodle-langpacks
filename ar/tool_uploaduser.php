...
$string['allowsuspends'] = 'اسمح بتعليق و تفعيل الحسابات';
...
$string['uploadusers_help'] = 'يمكن رفع المستخدمين (واختيارياً ضمهم إلى المساقات) عن طريق ملف نصي. تنسيق الملف ينبغي أن يكون على النحو التالي:
...
$string['uuoptype_addnew'] = 'أضف الجديد فقط، و تخطى المستخدمين الموجودين';
