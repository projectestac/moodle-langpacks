...
$string['aggregation'] = 'تجميع التقديرات';
...
$string['switchphase40info'] = 'أنت على وشك تحويل ورشة العمل إلى <strong> مرحلة تقييم الدرجات </strong>. في هذه المرحلة ، لا يمكن للمستخدمين تعديل عمليات الإرسال أو تقييماتهم. يمكن للمدرسين استخدام أدوات تقييم الدرجات لحساب الدرجات النهائية وتقديم التغذية الراجعة للمراجعين.';
