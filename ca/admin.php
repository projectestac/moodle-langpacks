...
$string['task_status_desc'] = 'La tasca \'{$a->name}\' és {$a->status}. Per a més detalls, vegeu {$a->class}{$a->extradescription} en <a href="{$a->gotourl}".Fes planificades</a>.';
