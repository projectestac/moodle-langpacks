...
/**
 * Strings for component 'moodle', language 'ca', branch 'MOODLE_30_STABLE'
 *
 * @package   moodle
...
$string['confirmdeletesection'] = 'Esteu segur que voleu suprimir "{$a}" i totes les activitats que conté?';
