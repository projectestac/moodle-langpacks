...
$string['eventcourseended'] = 'Curs finalitzat';
...
$string['eventcoursestarted'] = 'Curs iniciat';
...
$string['makeavailablecmtitle'] = 'Fes que l\'activitat estigui disponible';
...
$string['moodlenet:configoauthservice'] = 'Seleccioneu un servei MoodleNet OAuth 2 per habilitar la compartició en aquest lloc MoodleNet. Si el servei encara no existeix, haureu de <a href="{$a}">crear-lo</a>.';
$string['moodlenet:deletedactivity'] = 'Activitat esborrada';
$string['moodlenet:deletedcourse'] = 'Curs esborrat';
$string['moodlenet:eventresourceexported'] = 'Recurs exportat';
...
$string['moodlenet:sharefailtextwithsitesupport'] = 'S\'ha produït un error en compartir el vostre contingut a MoodleNet.<br>Torneu a provar-ho més tard o <a href="{$a}">contacteu amb el lloc d\'assistència</a>.';
...
$string['pluginmissingfromdisk'] = '{$a-)name} (Falta al disc)';
