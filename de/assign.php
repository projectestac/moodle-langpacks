...
$string['cutoffdate'] = 'Verlängertes Abgabeende';
$string['cutoffdatecolon'] = 'Endgültiges Abgabeende: {$a}';
$string['cutoffdatefromdatevalidation'] = 'Das endgültige Abgabeende muss nach dem Abgabebeginn liegen.';
...
$string['cutoffdatevalidation'] = 'Das endgültige Abgabeende muss nach dem (normalen) Abgabeende liegen.';
...
$string['duedate_help'] = 'Zum Abgabeende wird die Aufgabe fällig. Wenn spätere Abgaben erlaubt sind, wird jede nach diesem Datum eingereichte Abgabe als verspätet markiert. Um eine Abgabe nach einem bestimmten Verspätungsdatum zu verhindern, kann ein verlängertes Abgabedatum gesetzt werden.';
$string['duedateno'] = 'Kein Abgabeende';
$string['duedatereached'] = 'Das Abgabeende für diese Aufgabe ist vorbei.';
