...
/**
 * Strings for component 'local_amos', language 'de', branch 'MOODLE_27_STABLE'
 *
 * @package   local_amos
...
$string['about'] = '<p>AMOS bedeutet <strong>Automated Manipulation Of Strings</strong> und steht für die Bearbeitung und Verwaltung der Moodle-Sprachpakete.</p>
<p>AMOS ist das zentrale Repository für die Moodle-Texte. AMOS protokolliert alle Veränderungen bei den englischen Originaltexten und ermöglicht die Übersetzung in die jeweiligen Sprachen. AMOS koordiniert die gemeinschaftliche Übersetzung und erzeugt automatisch die offiziellen Sprachpakete.</p>
