...
/**
 * Strings for component 'message', language 'de', branch 'MOODLE_32_STABLE'
 *
 * @package   message
...
$string['deleteallconfirm'] = 'Möchten Sie wirklich die Kommunikation vollständig löschen?';
...
$string['errortranslatingdefault'] = 'Fehler in der Plugin-Einstellung, stattdessen werden die Standardeinstellungen benutzt.';
...
$string['hidemessagewindow'] = 'Mitteilungfenster verstecken';
$string['hidenotificationwindow'] = 'Benachrichtigungsfenster verstecken';
$string['keywords'] = 'Schlagwörter';
$string['loggedin'] = 'Online';
$string['loggedindescription'] = 'Wenn Sie in Moodle angemeldet sind.';
$string['loggedin_help'] = 'Konfigurieren Sie wie Sie Benachrichtigungen empfangen wollen, wenn Sie in Moodle angemeldet sind.';
$string['loggedoff'] = 'Offline';
$string['loggedoffdescription'] = 'Wenn  Sie nicht in Moodle angemeldet sind';
$string['loggedoff_help'] = 'Konfigurieren Sie wie Sie Benachrichtigungen empfangen wollen, wenn Sie nicht in Moodle angemeldet sind.';
