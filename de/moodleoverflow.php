...
$string['la_endtime_help'] = 'Teilnehmer/innen können nach dem eingerichteten Zeitpunkt keine Fragen mehr beantworten.';
...
$string['la_starttime_help'] = 'Die Teilnehmer/innen können bis zum eingerichteten Zeitpunkt keine Fragen beantworten.';
$string['la_starttime_ruleerror'] = 'Anfangszeit muss in der Zukunft liegen';
$string['lastpost'] = 'Letzter Beitrag';
$string['limitedanswer_helpicon_teacher'] = 'Dies kann in den Einstellungen des Moodleoverflows geändert werden.';
$string['limitedanswer_info_endtime'] = 'Beiträge können nach {$a->limitedanswerdate} nicht beantwortet werden.';
$string['limitedanswer_info_start'] = 'Dieser Moodleoverflow ist im eingeschränkten Antwortmodus.';
$string['limitedanswer_info_starttime'] = 'Beiträge können bis {$a->limitedanswerdate} nicht beantwortet werden.';
$string['limitedanswerheading'] = 'Eingeschränkter Antwortmodus';
$string['limitedanswerwarning_answers'] = 'Es gibt bereits beantwortet Beiträge in diesem Moodleoverflow.';
$string['limitedanswerwarning_conclusion'] = 'Sie können nur eine Zeit festlegen bis Teilnehmer/innen in der Lage sind, die Fragen zu beantworten';
