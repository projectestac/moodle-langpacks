...
$string['matchingfile'] = 'Passend aus der Datei <span class="filename">{$a}</span>';
$string['matchingfiles'] = 'Passend aus den Dateien:';
$string['next'] = 'Weiter';
...
$string['queryerror'] = 'Ihre Anfrage für die Suchmaschine konnte nicht umgesetzt werden: {$a}';
...
$string['viewresultincontext'] = 'Dieses Ergebnis im Kontext anzeigen';
