...
$string['smartmenusmenuitemtype_help'] = '<p>Wählen Sie den Menütyp aus, den Sie erstellen möchten. Wählen Sie zwischen "Statisch", "Überschrift", "Moodle-Dokumentation", "Dynamische Kurse" und "Trenner".</p><ul><li>Statisch: Ein statischer Menüpunkt ist einfach ein Link zu einer festen URL, die sich nicht ändert.</li><li>Überschrift: Ein Menüpunkt mit einer Überschrift gruppiert verwandte Menüpunkte unter einer gemeinsamen Überschrift. Er enthält keinen Link und ist nicht anklickbar.</li><li>Trenner: Ein Trennzeichen zeigt eine horizontale Linie im Menü an, um Gruppen von Menüpunkten optisch zu trennen.</li><li>Moodle-Dokumentation: Ein Menüpunkt in der Moodle-Dokumentation dient dazu, auf den entsprechenden MoodleDocs-Artikel zu verlinken, ähnlich dem MoodleDocs-Link in der Moodle-Fußzeile (Fragezeichen-Symbol).</li><li>Dynamische Kurse: Ein Menüpunkt mit dynamischen Kursen zeigt eine Liste von Kursen basierend auf bestimmten Kriterien an, wie z.B. Kurskategorie, Rolle bei der Kursanmeldung, Kursabschlussstatus oder Datumsbereich. Der in einem dynamischen Kursmenüelement angezeigte Inhalt wird automatisch aktualisiert, wenn sich die Kriterien ändern.</li></ul>';
