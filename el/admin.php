...
$string['profilefieldlink_help'] = 'Για να μετατρέψετε το κείμενο σε έναν σύνδεσμο, καταχωρίστε μια διεύθυνση URL που περιέχει το $$, όπου το $$ θα αντικατασταθεί με το κείμενο. Για παράδειγμα, για να μετατρέψετε ένα αναγνωριστικό Twitter σε έναν σύνδεσμο, πληκτρολογήστε https://twitter.com/$$.';
...
<li> Μπορείτε να έχετε πρόσβαση και να ενεργοποιήσετε τις ειδοποιήσεις κινητών τηλεφώνων από τον ιστότοπό σας Moodle μέσω της δωρεάν <a href="https://download.moodle.org/mobile/">εφαρμογής Moodle app για κινητά</a> μας. </ li>
...
$string['registration_help'] = 'Με την εγγραφή:

* Θα λαμβάνετε ειδοποιήσεις ασφαλείας
* Μπορείτε να ενεργοποιήσετε την προώθηση ειδοποιήσεων της εφαρμογής για κινητά από τον ιστότοπό σας
* Συμβάλλετε στις στατιστικές Moodle της παγκόσμιας κοινότητας';
...
$string['requiredentrieschanged'] = 'Σημείωση: Μετά την αναβάθμιση, η ρύθμιση «Απαιτούμενες καταχωρήσεις πριν από την προβολή» επιβάλεται τώρα στις ακόλουθες δραστηριότητες βάσης δεδομένων:<br/>{$a->text}<br/>';
...
$string['upgradeforumread'] = 'Μια καινούργια δυνατότητα προστέθηκε στο Moodle 1.5 για την ανίχνευση διαβασμένων/μη-διαβασμένων αναρτήσεων φόρουμ.<br />Για να χρησιμοποιήσετε τη δυνατότητα αυτή πρέπει να <a href="{$a}">ενημερώσετε τους πίνακές σας</a>.';
