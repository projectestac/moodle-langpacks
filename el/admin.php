...
$string['configeditorfontlist'] = 'Επιλέξτε τις γραμματοσειρές που θα εμφανίζονται στην αναδυόμενη λίστα του επεξεργαστή κειμένου.';
...
$string['devlibdirpresent'] = 'Οι κατάλογοι με βιβλιοθήκες ανάπτυξης όπως <em>vendor</em> ή <em>node_modules</em> δεν θα πρέπει να υπάρχουν σε δημόσιους ιστοτόπους. Δείτε την <a href="{$a->moreinfourl}">αναφορά επισκόπησης ασφαλείας</a> για περισσότερες λεπτομέρειες.';
...
$string['pathtounoconv'] = 'Διαδρομή (πλήρες όνομα αρχείου) προς τον μετατροπέα εγγράφων UnoConv';
$string['pathtounoconv_help'] = 'Διαδρομή (πλήρες όνομα αρχείου) προς τον μετατροπέα UnoConv (Universal Office Converter). Αυτό είναι ένα εκτελέσιμο πρόγραμμα ικανό για μετατροπή μεταξύ μορφότυπων εγγράφων που υποστηρίζονται από το LibreOffice. Αυτό είναι προαιρετικό, αλλά αν οριστεί, το Moodle θα το χρησιμοποιεί για να μετατρέπει αυτόματα μεταξύ μορφότυπων εγγράφων. Χρησιμοποιείται για την υποστήριξη ακόμα περισσότερων μορφότυπων στα αρχεία εισόδου για την λειτουργία επισημειώσεως PDF στις εργασίες που υποβάλλονται.';
...
$string['sitepolicyguest_help'] = 'Αν έχετε πολιτική ιστότοπου που όλοι οι επισκέπτες πρέπει να βλέπουν και να εγκρίνουν πριν από τη χρήση αυτού του ιστότοπου, προσδιορίστε εδώ τη διεύθυνση URL της πολιτικής σας, διαφορετικά αφήστε αυτό το πεδίο κενό. Αυτή η ρύθμιση μπορεί να περιέχει οποιαδήποτε δημόσια διεύθυνση URL. Σημείωση: Η πρόσβαση μη εγγεγραμμένων χρηστών μπορεί να προληφθεί με τη ρύθμιση forcelogin.';
...
$string['taskeventscron'] = 'Επεξεργασία υπόβαθρου για γεγονότα';
...
$string['taskgradecron'] = 'Επεξεργασία υπόβαθρου για βαθμολόγιο';
$string['tasklegacycron'] = 'Επεξεργασία της εντολής χρονοπρογραμματισμού cron παλαιού τύπου για πρόσθετα';
$string['taskmessagingcleanup'] = 'Επεξεργασία υπόβαθρου για την ανταλλαγή μηνυμάτων';
$string['taskpasswordresetcleanup'] = 'Εκκαθάριση προσπαθειών επαναφοράς κωδικού πρόσβασης';
$string['taskplagiarismcron'] = 'Επεξεργασία στο παρασκήνιο για την εντολή χρονοπρογραμματισμού cron παλαιού τύπου σε πρόσθετα λογοκλοπής';
$string['taskportfoliocron'] = 'Επεξεργασία στο παρασκήνιο για πρόσθετα χαρτοφυλακίου';
$string['taskquestioncron'] = 'Επεξεργασία υπόβαθρου για μηχανή ερωτήσεων';
...
$string['taskstatscron'] = 'Επεξεργασία υπόβαθρου για στατιστικές';
$string['tasktagcron'] = 'Επεξεργασία υπόβαθρου για ετικέτες';
...
$string['upgradesettingsintro'] = 'Οι παρακάτω ρυθμίσεις προστέθηκαν κατά την αναβάθμιση του Moodle. Αλλάξτε ό,τι θεωρείτε απαραίτητο στα προεπιλεγμένα και μετά κάντε κλικ στο πλήκτρο «Αποθήκευση αλλαγών» στο κάτω μέρος αυτής της σελίδας.';
