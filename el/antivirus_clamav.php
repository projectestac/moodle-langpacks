...
$string['configclamfailureonupload'] = 'Αν έχετε ρυθμίσει το πρόγραμμα clam για να σαρώνει τα ανεβασμένα αρχεία αλλά δεν έχει ρυθμιστεί σωστά ή αποτυγχάνει να εκτελεστεί για κάποιον άγνωστο λόγο, πώς θέλετε να ενεργήσει; Αν επιλέξετε «Θεώρησε οτι τα αρχεία περιέχουν ιούς», θα μεταφερθούν στην περιοχή καραντίνας ή θα διαγραφούν. Αν επιλέξετε «Θεώρησε ότι τα αρχεία δεν περιέχουν ιούς», τα αρχεία θα μεταφερθούν στον φάκελο προορισμού όπως συνήθως. Σε κάθε περίπτωση, οι διαχειριστές θα ενημερωθούν ότι το clam απέτυχε. Αν επιλέξετε «Θεώρησε οτι τα αρχεία περιέχουν ιούς» και για κάποιο λόγο το clam αποτύχει να εκτελεστεί (συνήθως διότι έχετε εισαγάγει λανθασμένη διαδρομή ως το clam), τότε ΟΛΑ τα ανεβασμένα αρχεία θα μεταφερθούν στην ορισμένη περιοχή καραντίνας ή θα διαγραφούν. Προσοχή με αυτή τη ρύθμιση.';
