...
$string['attemptreopenmethod_help'] = 'Καθορίζει τον τρόπο εκ νέου ανοίγματος των προσπαθειών υποβολής μαθητών. Οι διαθέσιμες επιλογές είναι:

* Ποτέ - Η υποβολή του μαθητή δεν μπορεί να ξανανοίξει.
* Χειροκίνητα - Η υποβολή του μαθητή μπορεί να ανοίξει εκ νέου από έναν διδάσκοντα.
* Αυτόματα μέχρι να περάσει - Η υποβολή του μαθητή ανοίγει αυτόματα μέχρι να πετύχει ο μαθητής την βαθμολογία που έχει οριστεί στο βαθμολόγιο για αυτήν την ανάθεση.';
