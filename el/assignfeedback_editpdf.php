...
$string['editpdf_help'] = 'Σχολιασμός των υποβολών μαθητή απευθείας στον περιηγητή και δημιουργία ενός επεξεργασμένου PDF που μπορεί να κατεβεί.';
$string['enabled'] = 'Σχολιασμός PDF';
$string['enabled_help'] = 'Εάν ενεργοποιηθεί, ο διδάσκων μπορεί να δημιουργήσει σχολιασμένα PDF αρχεία όταν βαθμολογεί υποβολές εργασίας. Αυτό επιτρέπει στον διδάσκοντα να προσθέτει σχόλια, σχήματα και σφραγίδες απευθείας πάνω στην εργασία των μαθητών. Ο σχολιασμός γίνεται στον περιηγητή και δεν απαιτείται επιπλέον λογισμικό.';
