...
$string['gradesfile_help'] = 'Φύλλο εργασίας βαθμολόγησης με τροποποιημένες βαθμολογίες. Αυτό το αρχείο πρέπει να είναι ένα αρχείο csv που έχει ληφθεί από αυτή την εργασία και πρέπει να περιέχει στήλες για τον βαθμό μαθητή και αναγνωριστικό. Η κωδικοποίηση για το αρχείο πρέπει να είναι "UTF-8"';
