...
$string['auth_ldap_expireattr_desc'] = 'Προαιρετικό: Παρακάμπτει το ιδιοχαρακτηριστικό LDAP που αποθηκεύει το χρόνο λήξης του κωδικού πρόσβασης.';
...
$string['auth_ldap_passwdexpire_settings'] = 'Ρυθμίσεις λήξης του κωδικού πρόσβασης LDAP';
...
$string['auth_ldap_preventpassindb_key'] = 'Χωρίς κρυφή αποθήκευση κωδικών πρόσβασης';
