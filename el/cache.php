...
$string['cacheadmin'] = 'Διαχείρηση κρυφής μνήμης';
...
$string['localstorenotification'] = 'Αυτή η κρυφή μνήμη μπορεί με ασφάλεια να συνδεθεί με έναν χώρο τοπικό σε κάθε εξυπηρετητή ιστού.';
...
$string['sharedstorenotification'] = 'Αυτή η κρυφή μνήμη πρέπει να συνδεθεί με έναν αποθηκευτικό χώρο ο οποίος μοιράζεται σε όλους τους ιστοτόπους.';
