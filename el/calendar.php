...
$string['detailedmonthviewfor'] = 'Λεπτομερής μηναία προβολή για:';
$string['detailedmonthviewtitle'] = 'Λεπτομερής μηναία προβολή: {$a}';
...
$string['errorinvalidbydayprefix'] = 'Οι ακέραιες τιμές που προηγούνται των κανόνων BYDAY μπορούν να εμφανιστούν μόνο για έναν επαναλαμβανόμενο κανόνα MONTHLY ή YEARLY.';
