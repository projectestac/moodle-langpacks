...
/**
 * Strings for component 'completion', language 'el', branch 'MOODLE_32_STABLE'
 *
 * @package   completion
...
$string['completionexpected_help'] = 'Αυτή η ρύθμιση καθορίζει την ημερομηνία κατά την οποία αναμένεται να ολοκληρωθεί η δραστηριότητα. Η ημερομηνία δεν εμφανίζεται στους μαθητές και εμφανίζεται μόνο στην αναφορά ολοκλήρωσης δραστηριότητας.';
...
$string['enablecompletion_help'] = 'Αν είναι ενεργοποιημένη, οι συνθήκες ολοκλήρωσης δραστηριότητας μπορεί να οριστούν στις ρυθμίσεις δραστηριότητας και / ή μπορεί να οριστούν στις ρυθμίσεις ολοκλήρωσης μαθήματος.';
...
$string['eventcoursemodulecompletionupdated'] = 'Ενημέρωση ολοκλήρωσης αρθρώματος μαθήματος';
