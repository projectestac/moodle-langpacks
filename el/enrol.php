...
$string['rolefromsystem'] = '{$a->role} (Εκχωρημένος σε επίπεδο ιστότοπου)';
...
$string['unenrolconfirm'] = 'Είστε βέβαιοι οτι θέλετε να κάνετε απεγγραφή του χρήστη "{$a->user}" από το μάθημα "{$a->course}";';
