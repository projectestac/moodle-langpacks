...
$string['dbhost_desc'] = 'Πληκτρολογήστε την IP διεύθυνση του εξυπηρετητή της βάσης δεδομένων ή το όνομα κεντρικού Η/Υ.
Χρησιμοποιήστε ένα όνομα συστήματος DSN εάν χρησιμοποιείτε ODBC.';
