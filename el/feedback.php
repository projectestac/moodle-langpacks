...
$string['bold'] = 'Έντονο';
$string['calendarend'] = 'Η ανατροφοδότηση {$a} κλείνει';
$string['calendarstart'] = 'Η ανατροφοδότηση {$a} ανοίγει';
...
$string['cannotmapfeedback'] = 'Πρόβλημα με τη βάση δεδομένων. Αδυναμία αντιστοίχησης ανατροφοδότησης με μάθημα';
...
$string['check_values'] = 'Πιθανές απαντήσεις';
...
$string['continue_the_form'] = 'Συνεχίστε να απαντάτε στις ερωτήσεις ...';
...
$string['downloadresponseas'] = 'Κάντε λήψη όλων των απαντήσεων ως:';
$string['dropdown'] = 'Πολλαπλών επιλογών - επιτρέπεται μια απάντηση (αναπτυσσόμενη λίστα)';
$string['dropdownlist'] = 'Πολλαπλών επιλογών - μια απάντηση (αναπτυσσόμενη λίστα)';
$string['dropdownrated'] = 'Αναπτυσσόμενη λίστα (βαθμολογημένη)';
...
$string['feedback:mapcourse'] = 'Αντιστοίχηση μαθημάτων σε καθολική ανατροφοδότηση (ιστοτόπου)';
...
$string['feedback:viewreports'] = 'Προβολή αναφορών';
$string['file'] = 'Αρχείο';
...
$string['mapcourse'] = 'Αντιστοίχηση ανατροφοδότησης σε μάθημα';
...
$string['mapcourses'] = 'Αντιστοίχηση ανατροφοδότησης σε μαθήματα';
$string['mapcourses_help'] = 'Αφού επιλέξετε το ή τα σχετικά μαθήματα από την αναζήτησή σας, μπορείτε να τα συσχετίσετε με αυτή την ανατροφοδότηση με τη χρήση αντιστοίχισης μαθημάτων. Μπορείτε να επιλέξετε περισσότερα από ένα μαθήματα κάνοντας κλικ στα ονόματα των μαθημάτων ενώ κρατάτε  πατημένο το πλήκτρο Apple ή Ctrl. Ένα μάθημα μπορεί να απο-συσχετιστεί από μια ανατροφοδότηση ανά πάσα στιγμή.';
...
$string['oldvalueswillbedeleted'] = 'Οι τρέχουσες ερωτήσεις και όλες οι απαντήσεις θα διαγραφούν.';
...
$string['radiobutton'] = 'Πολλαπλών επιλογών - επιτρέπεται μια απάντηση (radio buttons: κουμπιά επιλογής)';
...
$string['relateditemsdeleted'] = 'Όλες οι αποκρίσεις για αυτήν την ερώτηση θα διαγραφούν επίσης.';
...
$string['response_nr'] = 'Αριθμός απάντησης';
...
$string['show_nonrespondents'] = 'Εμφάνιση όσων δεν απάντησαν';
...
$string['viewcompleted'] = 'ολοκληρωμένες ανατροφοδοτήσεις';
$string['viewcompleted_help'] = 'Μπορείτε να δείτε φόρμες ολοκληρωμένων ανατροφοδοτήσεων, αναζητήσιμες ανά μάθημα και/ή ανά ερώτηση. Οι αποκρίσεις ανατροφοδότησης μπορούν να εξαχθούν σε Excel.';
