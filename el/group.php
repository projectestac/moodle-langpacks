...
* Καθόλου ομάδες - Δεν υπάρχουν υπο-ομάδες· όλοι είναι μέρος μιας μεγάλης κοινότητας
* Ξεχωριστές ομάδες - Κάθε μέλος της ομάδας μπορεί να δει μόνο τη δική του ομάδα· οι άλλοι είναι αόρατοι
* Ορατές ομάδες - Κάθε μέλος της ομάδας εργάζεται στη δική του ομάδα αλλά μπορεί να δει και άλλες ομάδες

Ο τρόπος λειτουργίας ομάδων που ορίζεται σε επίπεδο μαθήματος είναι ο προεπιλεγμένος τρόπος για όλες τις δραστηριότητες στο μάθημα. Κάθε δραστηριότητα που υποστηρίζει ομάδες, μπορεί επίσης να έχει ορισμένο το δικό της τρόπο, αν και σε περίπτωση που ο τρόπος είναι υποχρεωτικός σε επίπεδο μαθήματος, η ρύθμιση του τρόπου για κάθε δραστηριότητα θα αγνοηθεί.';
