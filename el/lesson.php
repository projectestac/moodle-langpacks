...
$string['activitylink_help'] = 'Για να παρέχετε ένα σύνδεσμο στο τέλος της διδακτικής ενότητας προς μια άλλη δραστηριότητα του μαθήματος, επιλέξτε την δραστηριότητα από το πτυσσόμενο μενού.';
