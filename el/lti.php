...
$string['allowinstructorcustom'] = 'Να επιτρέπεται στους διδάσκοντες να προσθέτουν προσαρμοσμένες παραμέτρους';
...
$string['curllibrarymissing'] = 'Για χρήση του εξωτερικού εργαλείου LTI, απαιτείται η βιβλιοθήκη PHP cURL.';
...
$string['forced_help'] = 'Αυτή η ρύθμιση έχει επιβληθεί στις ρυθμίσεις κάποιου εργαλείου ή σε επίπεδο ιστότοπου. Δεν μπορείτε να την αλλάξετε από αυτήν τη διεπαφή.';
...
$string['secure_icon_url_help'] = 'Παρόμοια με τη διεύθυνση URL του εικονιδίου, αλλά χρησιμοποιείται αν ο χρήστης έχει πρόσβαση στο Moodle με ασφάλεια μέσω SSL. Ο κύριος σκοπός αυτού του πεδίου είναι να εμποδίσει τον περιηγητή να προειδοποιεί τον χρήστη εάν η υποκείμενη σελίδα έχει πρόσβαση μέσω SSL, αλλά ζητά να παρουσιάσει μια μη ασφαλή εικόνα.';
