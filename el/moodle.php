...
$string['enddate_help'] = 'Η ημερομηνία λήξης του μαθήματος χρησιμοποιείται για να προσδιοριστεί αν ένα μάθημα πρέπει να συμπεριληφθεί στη λίστα μαθητών της πλοήγησης. Όταν η ημερομηνία λήξης λήξει, το μάθημα δεν εμφανίζεται πλέον. Η ημερομηνία λήξης του μαθήματος μπορεί επίσης να χρησιμοποιηθεί από προσαρμοσμένες αναφορές. Οι χρήστες μπορούν ακόμα να εισέλθουν στο μάθημα μετά την ημερομηνία λήξης. Mε άλλα λόγια η ημερομηνία δεν περιορίζει την πρόσβαση.';
...
$string['idnumbermod_help'] = 'Ο ορισμός ενός αναγνωριστικού αριθμού παρέχει έναν τρόπο προσδιορισμού της δραστηριότητας για λόγους υπολογισμού βαθμολογίας. Αν η δραστηριότητα δε συμπεριλαμβάνεται σε κάποιο υπολογισμό βαθμολογίας τότε το πεδίο αναγνωριστικός αριθμός μπορεί να μείνει κενό.

Ο αναγνωριστικός αριθμός μπορεί επίσης να οριστεί στο βαθμολόγιο, αν και μπορεί να αλλαχθεί μόνο στη σελίδα ρυθμίσεων της δραστηριότητας.';
...
$string['registrationcontactno'] = 'Όχι, δε θέλω φόρμα επικοινωνίας στην καταχώρηση του ιστοτόπου';
