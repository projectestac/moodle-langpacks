...
$string['coursesearch_help'] = 'Μπορείς να αναζητήσεις πολλές λέξεις με μια φορά.<p>word: εύρεση ταιριάσματος αυτής της λέξης μέσα στο κείμενο. <br />+word: μόνο ακριβείς λέξεις θα βρεθούν. <br />-word: μη συμπεριλάβετε τα αποτελέσματα που περιέχουν αυτήν η λέξη.';
