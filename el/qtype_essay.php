...
$string['mustattach'] = 'Όταν έχει επιλεγεί «Χωρίς κείμενο σε σύνδεση» ή οι απαντήσεις είναι προαιρετικές, πρέπει να επιτρέπεται τουλάχιστον ένα συνημμένο.';
...
$string['pluginname_help'] = 'Σε απάντηση μιας ερώτησης, αυτός που απαντά μπορεί να ανεβάσει ένα ή περισσότερα αρχεία και/ή να εισάγει κείμενο κατά τη διάρκεια της σύνδεσης. Μπορεί να παρέχεται μια φόρμα απάντησης. Οι απαντήσεις πρέπει να βαθμολογηθούν χειροκίνητα.';
$string['pluginnamesummary'] = 'Επιτρέπει ως απάντηση το ανέβασμα ενός αρχείου και/ή κείμενο σε σύνδεση. Η απάντηση έπειτα θα πρέπει να βαθμολογηθεί χειροκίνητα.';
