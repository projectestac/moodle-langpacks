...
$string['rightanswer_help'] = 'Μια αυτόματα δημιουργημένη περίληψη της σωστής απάντησης. Αυτή μπορεί να είναι περιορισμένη, οπότε ίσως να θέλετε να το ξανασκεφτείτε και να εξηγήσετε την σωστή απάντηση στη γενική ανατροφοδότηση για την ερώτηση καλύτερα, και να απενεργοποιήσετε αυτή την επιλογή.';
