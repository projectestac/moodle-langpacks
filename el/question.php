...
$string['questionsinuse'] = '(* Ερωτήσεις μαρκαρισμένες με αστερίσκο χρησιμοποιούνται ήδη σε μερικά κουίζ. Αυτές οι ερωτήσεις δεν θα διαγραφούν απ\' αυτά τα κουίζ αλλά μόνο απ\' την λίστα της κατηγορίας.)';
...
$string['rightanswer_help'] = 'Μια αυτόματα δημιουργημένη περίληψη της σωστής απάντησης. Αυτή μπορεί να είναι περιορισμένη, γι\' αυτό ίσως να θέλετε να το ξανασκεφτείτε και να εξηγήσετε την σωστή απάντηση στη γενική ανατροφοδότηση για την ερώτηση καλύτερα, και να απενεργοποιήσετε αυτή την επιλογή.';
