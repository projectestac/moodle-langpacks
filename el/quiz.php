...
$string['emailconfirmbody'] = 'Αγαπητέ/-ή {$a->username},
...
Αυτό το μήνυμα επιβεβαιώνει ότι οι απαντήσεις σας έχουν ληφθεί με ασφάλεια.

Μπορείτε να δείτε αυτό το κουίζ στο {$a->quizurl}.';
...
$string['emailnotifybody'] = 'Αγαπητέ/-ή {$a->username},

Ο/Η {$a->studentname} έχει ολοκληρώσει το κουίζ
«{$a->quizname}» ({$a->quizurl})
στο μάθημα «{$a->coursename}»
...
$string['gradetopassnotset'] = 'Αυτό το κουίζ δεν έχει ορισμένο έναν βαθμό επιτυχίας οπότε δεν μπορείτε να χρησιμοποιήσετε αυτή την επιλογή. Παρακαλούμε, χρησιμοποιήστε αντί αυτού την ρύθμιση απαίτησης βαθμού.';
