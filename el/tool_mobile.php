...
$string['mobilenotificationsdisabledwarning'] = 'Οι ειδοποιήσεις για κινητά δεν είναι ενεργοποιημένες. Θα πρέπει να είναι ενεργοποιημένες στη «Διαχείριση εξόδων μηνυμάτων».';
