...
$string['check_indexes'] = 'Έλεγχος για ελλείποντα ευρετήρια';
...
$string['confirmcheckindexes'] = 'Αυτή η λειτουργία θα θα ψάξει για δείκτες που μπορεί να λείπουν στον εξυπηρετητή σας Moodle, δημιουργώντας (αλλά όχι εκτελώντας!) αυτόματα τις απαραίτητες δηλώσεις SQL για να διατηρήσουν τα πάντα ενημερωμένα.
...
$string['doc'] = 'Doc';
$string['docindex'] = 'Δείκτης τεκμηρίωσης:';
