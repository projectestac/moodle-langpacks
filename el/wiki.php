...
$string['insertimage_help'] = 'Αυτή η αναπτυσσόμενη λίστα θα εισαγάγει μια εικόνα στον επεξεργαστή wiki. Αν χρειάζεται να προσθέσετε περισσότερες εικόνες στο wiki, χρησιμοποιήστε την καρτέλα «Αρχεία».';
...
$string['invalidsesskey'] = 'Η σύνοδός σας πιθανότατα έχει λήξει (το κλειδί συνόδου \'sesskey\' που δόθηκε δεν είναι έγκυρο). Παρακαλούμε, σημειώστε την τροποποίησή σας και, στη συνέχεια, συνδεθείτε ξανά για να την στείλετε.';
