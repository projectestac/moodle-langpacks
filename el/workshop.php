...
$string['assessmentendevent'] = '{$a} (λήξη προθεσμίας για αξιολόγηση)';
...
$string['assessmentstartevent'] = '{$a} (έναρξη για αξιολογήσεις)';
...
$string['submissionendevent'] = '{$a} (λήξη προθεσμίας για υποβολές)';
