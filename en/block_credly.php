...
/**
 * Strings for component 'block_credly', language 'en', branch 'MOODLE_28_STABLE'
 *
...
$string['notconfigured'] = 'The credly block plugin is not configured properly.  Set the parameters <a href="{$a->configureurl}">here</a>.';
