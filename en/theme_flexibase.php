...
/**
 * Strings for component 'theme_flexibase', language 'en', branch 'MOODLE_28_STABLE'
 *
...
$string['choosereadme'] = '<p>flexibase is based on the Bootstrap3 parent theme (bootstrap), child theme (Cerulean) and the bootswatch Spacelab</p>
