...
$string['configlcalclifetime'] = 'Esto especifica el período de tiempo que desea conservar los datos de cálculo; esto no eliminará las predicciones, sino que elimina los datos utilizados para generar las predicciones. Usar la opción predeterminada aquí es mejor ya que mantiene el uso de su disco bajo control; sin embargo, si está usando tablas de cálculo para otros propósitos, es posible que desee aumentar este valor.';
...
$string['modeloutputdirwithdefaultinfo'] = 'Directorio donde los procesadores de predicción almacenan toda la información de evaluación. Útil para depurar e investigar. Si está vacío, se utilizará {$a} de forma predeterminada.';
...
$string['neverdelete'] = 'Nunca borre cálculos';
