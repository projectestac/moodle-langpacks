...
$string['enddate_help'] = 'La fecha de finalización del curso determina si un curso aparece como pasado en el resumen de cursos. La fecha de finalización del curso también puede ser utilizada por informes personalizados. Tenga en cuenta que los usuarios pueden seguir entrando en el curso después de la fecha de finalización; en otras palabras, la fecha no restringe el acceso.';
