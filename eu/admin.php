...
$string['configfiltermatchonepertext'] = 'Esteka automatikoaren iragazkiek esteka bakarra sortuko dute orriko testu-elementu bakoitzean aurkituko den lehenengo testu-adibide egokiarekiko, beste guztia alde batera utziz. Ezarpen hau ez da kontuan hartuko orriko ezarpen bakarra <i>bai</i> baldin bada.';
...
$string['configopentowebcrawlers'] = 'Aukera hau gaituz gero, Google gunera gonbidatu gisa sartu ahal izango da. Horrez gain, Google-ren bilaketaren bitartez gunera sartzen denak zuzenean gonbidatu gisa egingo du. Aukera honek sarrera zuzena soilik ematen du gonbidatuak onartzen dituzten ikastaroetara.';
...
$string['task_adhoc_concurrency_limit'] = 'Ad hoc zereginen konkurrentzia-muga';
$string['task_adhoc_concurrency_limit_desc'] = 'Aldi berean exekutatu ahal diren ad hoc zereginen gehienezko kopurua. Muga altua bada programatutako zereginak erregularki ez exekutatzea gertatu liteke ad hoc zeregin asko daudenean. 0 ezarriz gero ad hoc zereginen exekuzioa guztiz desgaituko da.';
$string['task_adhoc_max_runtime'] = 'Ad hoc zereginen gehienezko iraupena';
$string['task_adhoc_max_runtime_desc'] = 'Ad hoc zeregin batek iraun dezakeen gehienezko denbora askatua izan baino lehen. Hemen iraupen txikia jartzea gomendatzen da ez dagoelako ilaratu daitezkeen ad hoc zereginen mugarik. Zenbaki hau oso altua bada eta ad hoc zereginen ilara luzea baduzu gertatu liteke programatutako zereginak erregularki ez exekutatzea.';
$string['taskadmintitle'] = 'Zereginak';
...
$string['tasklogcleanup'] = 'Garbitu zereginen erregistroa';
$string['tasklogging'] = 'Zereginen-erregistroaren ezarpenak';
$string['task_logmode'] = 'Noiz erregistratu';
$string['task_logmode_all'] = 'Gorde zeregin guztien irteeraren erregistroa';
$string['task_logmode_desc'] = 'Zeregin-erregistroa noiz gertatuko den erabaki dezakezu. Berez erregistro guztiak gordetzen dira. Erregistroa erabat desgaitu dezakezu, edo huts egiten duten zereginen erregistroa baino ez gordetzea erabaki dezakezu.';
...
$string['task_logretainruns_desc'] = 'Mantendu beharreko zereginen exekuzio kopurua. Ezarpen honek \'Mantentze-epea\' ezarpenarekin batera funtzionatzen du: lehenago betetzen dena aplikatuko da.';
...
$string['task_logtostdout_desc'] = 'Zereginak exekutatzen eta irteera atzitzen ari denean, atzitutako irteera-loga zeregina exekutatzen ari den bitartean erakutsi behar den edo ez.';
...
$string['taskprocessing'] = 'Zereginen exekuzioak';
...
$string['task_scheduled_concurrency_limit'] = 'Programatutako zereginen konkurrentzia-muga';
$string['task_scheduled_concurrency_limit_desc'] = 'Batera exekutatu daitekeen programatutako zereginen exekuzio kopurua. Muga altua bada zerbitzariaren errendimenduan eragina izan dezake. 0 ezarriz gero programatutako zereginen exekuzioa guztiz desgaituko da.';
$string['task_scheduled_max_runtime'] = 'Programatutako zereginen exekuzioen gehienezko iraupena';
$string['task_scheduled_max_runtime_desc'] = 'Programatutako zereginen exekuzioen gehienezko denbora askatua izan baino lehen.';
