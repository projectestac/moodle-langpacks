...
$string['aspectratiotootallorwide'] = 'Igotako irudia gorde da, baina mesedez egiaztatu ezazu, <strong>{$a->tallorwide}</strong> izan daitekeelako. Ondo erakusten ez bada, mesedez moztu ezazu tamaina horizontal estandarra izan dezan eta berriz igo ezazu. Esaterako 200 pixel zabaleran eta 300 pixeleko altueran tamaina egokia litzateke.';
...
$string['backupfailed'] = 'Berreskuratzeak huts egin du';
...
$string['browserstorage'] = 'Nabigatzailearen biltegia';
...
$string['complete-n-auto'] = 'Osatu gabeko elementua. Osatutzat markatuko da osatze-baldintzak betetzen dituzunean. Ezin duzu hau eskuz aldatu.';
...
$string['jsmaxstoreditems'] = 'Nabigatzaile-saioko biltegiratzerako gehienezko eduki-elementu kopurua';
$string['jsmaxstoreditems_desc'] = 'Erabiltzaileak lauzen pantaila orokorrean nabigatzen ari direnean nabigatzaileak Lauzen aurrebistarako pantailaren HTML bera eta lauza bakoitzaren edukia gordeko ditu, hemen zehaztutako elementu kopurura arte. Honela lauza berri batean klik egitean erantzuna oso azkarra izatea lortzen da. Ezarpen honetan balio oso altu bat jartzeak nabigatzailearen biltegia bete lezake (egindako probetan honek arazorik eragin ez duen arren).';
...
$string['jsstoredcontentdeletemins'] = 'Saioan gordetako edukia ezabatzeko epea (minututan)';
$string['jsstoredcontentdeletemins_desc'] = 'Lauza bakoitzeko klik bakoitzaren ostean, uneko HTMLrako lekua izate aldera, erabiltzailearen nabigatzaileak garbiketa bat egingo du eta hau baino zaharragoa den edukia saioaren biltegitik <em>ezabatuko</em> du (dagoeneko fidagarria ez delakoan, eta edozein modutan zerbitzaritik kopia berri bat egingo delarik).';
$string['jsstoredcontentexpirysecs'] = 'Saioan gordetako edukia iraungitzeko epea (segundotan)';
$string['jsstoredcontentexpirysecs_desc'] = 'Erabiltzaile batek lauza batean klik egiten duenean, nabigatzailearen saio-biltegian dagoen lauzaren edukia balio hau baino zaharragoa bada, edukia hala ere erakutsiko da baina atzeko planoan zerbitzariari edukia freskatu eta ordezkatzeko eskaera egingo zaio. Modu honetan ikastaroaren edukiak nabigatzaileak kopiatu ondoren eguneratzea ahalbidetzen du. Edukia balio hau baino berriagoa bada, eguneratuta dagoela suposatuko da eta ez zaio zerbitzariari eskaerarik egingo.';
