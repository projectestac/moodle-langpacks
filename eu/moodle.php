...
$string['noticenewerbackup'] = 'Ziurtasun-kopia Moodle-ko {$a->backuprelease} ({$a->backupversion}) bertsioarekin egin zen bertsio hori eta instalatutako Moodle bertsioa baino berriagoa da {$a->serverrelease} ({$a->serverversion}). Honek arazoak sor litzake ezin delako segurtasun-kopien fitxategien atzerabegirako bateragarritasuna bermatu.';
