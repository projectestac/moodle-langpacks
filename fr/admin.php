...
$string['unsupporteddbtablerowformat'] = 'Votre base de données comporte des tables qui utilisent le format de fichier Antelope. Il vous est vivement recommandé de convertir les tables au format de fichier Barracuda. Veuillez consulter la documentation sur l\'<a href="https://docs.moodle.org/en/cli">Administration en ligne de commande</a> pour des informations détaillées sur l\'outil de conversion des tables InnoDB en format Barracuda.';
