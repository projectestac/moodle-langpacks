...
/**
 * Strings for component 'admin', language 'fr', branch 'MOODLE_30_STABLE'
 *
 * @package   admin
...
$string['taskcompletiondaily'] = 'Achèvement marqué comme commencé';
...
$string['upgradekeyreq'] = 'Mise à jour de la clef nécessaire';
