...
$string['auth_changingemailaddress'] = 'Vous avez demandé la modification d’adresse de courriel, de {$a->oldemail} à {$a->newemail}. Pour des raisons de sécurité, un message de confirmation vous est envoyé à la nouvelle adresse afin de confirmer qu’elle vous appartient. Votre adresse de courriel sera modifiée dès que vous aurez cliqué sur l’URL indiquée dans le message envoyé. Le lien de confirmation expirera dans <b>10 minutes</b>';
