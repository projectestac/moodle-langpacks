...
$string['minimum_show_help'] = 'La note minimale est utilisées dans le calcul des notes et pondérations. Si elle n\'est pas affichées, la note minimale est fixée à 0 et ne peut pas être modifiée.';
