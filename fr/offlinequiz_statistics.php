...
/**
 * Strings for component 'offlinequiz_statistics', language 'fr', branch 'MOODLE_27_STABLE'
 *
...
$string['differentquestions'] = '- Vos groupes de test hors_ligne contiennent des jeux de questions différents.';
...
$string['offlinequizinformation'] = 'Information du test hors_ligne';
$string['offlinequizname'] = 'Nom du test hors-ligne';
$string['offlinequizoverallstatistics'] = 'Statistiques globales du test hors_ligne';
$string['offlinequizstructureanalysis'] = 'Analyse structurelle du test';
...
$string['statisticshelp'] = 'Aide pour les statistiques de tests hors_ligne';
...
$string['statsfor'] = 'Statistiques de test hors_ligne pour {$a}';
