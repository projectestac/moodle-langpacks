...
$string['currentstatusnext_help'] = 'Dans certains cas, l\'attibution est planifiée de façon à être effectuée automatiquement de nouveau, même si elle a été déjà faite. Ceci peut se passer par exemple si le délai de remise des travaux a été prolongé.';
