...
$string['local_mobiletypeoflogin'] = 'Escolla o tipo de autenticación';
$string['local_mobiletypeoflogin_key'] = 'Tipo de autenticación';
$string['local_mobileurlscheme'] = 'Empregue esta opción para forzar o esquema de enderezo URL para a autenticación a través da fiestra do navegador. Na maioría dos casos debe deixala baleira.';
$string['local_mobileurlscheme_key'] = 'Esquema de enderezo URL';
$string['loginintheapp'] = 'A través da aplicación';
$string['logininthebrowser'] = 'A través da xanela do navegador (para engadidos SSO)';
$string['loginintheinappbrowser'] = 'Mediante un navegador incorporado (para engadidos SSO)';
$string['mainmenu'] = 'Menú principal';
$string['mobilefeatures'] = 'Características de Mobile';
$string['mod_scorm_protectpackagedownloads'] = 'Protexer as descargas de paquetes';
$string['mod_scorm_protectpackagedownloads_desc'] = 'Se está activado, os paquetes SCORM poden ser descargados unicamente se o usuario do curso ten o permiso course:manageactivities. Se non está activo, os paquetes SCORM poden ser descargados sempre (mediante medios móbiles, ou outros).';
$string['mod_scorm_settings'] = 'Axuste específico para o módulo SCORM';
