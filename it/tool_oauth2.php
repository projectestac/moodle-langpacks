...
$string['authconnected'] = 'L\'account di sistema non è ora collegato per accesso offline.';
$string['authnotconnected'] = 'L\'account di sistema non è stato collegato per accesso offline.';
...
$string['createfromtemplatedesc'] = 'Nell\'elenco sottostante è possibile selezionare un modello di servizio OAuth 2 con configurazione valida per i tipi di servizio riconosciuti. Tramite la selezione del modello sarà creato un servizio OAuth 2 con i corretti endpoint e con i parametri necessari all\'autenticazione, tuttavia prima di utilizzare il servizio sarà comunque necessario inserire il client ID ed il client secret.';
...
$string['deleteconfirm'] = 'Sei sicuro di eliminare il fornitore di identità {$a}"? Tutti i plugin che utilizzano il fornitore smetteranno di funzionare.';
$string['deleteendpointconfirm'] = 'Sei sicuro di eliminare l\'endpoint "{$a->endpoint}" del fornitore "{$a->issuer}"? Tutti i plugin che utilizzano l\'endpoint smetteranno di funzionare.';
...
$string['discovered_help'] = 'L\'individuazione significa che gli endpoint OAuth2 possono essere trovati automaticamente a partire dall\'URL base del servizio OAuth. Non tutti i servizi richiedono di essere "individuati", in assenza tuttavia gli endpoint e la mappatura dei dati utenti dovrà essere inserita manualmente.';
...
$string['edituserfieldmapping'] = 'Modifica mappatura di campo del fornitore {$a->issuer}';
...
$string['issuerloginparams_help'] = 'Alcuni sistemi richiedono parametri aggiuntivi per poter leggere il profilo base di un utente';
...
$string['issuername_help'] = 'Nome del fornitore di identità. Potrà essere visualizzata nella pagina di autenticazione.';
