...
$string['configallowassign'] = 'あなたは左側に表示されているロールのユーザにいくつかのカラムのロールを他のユーザに割り当てることができるようにします。';
...
$string['configallowoverride'] = 'あなたは左側に表示されているロールのユーザにいくつかのカラムのロールをオーバーライドできるようにすることができます。';
