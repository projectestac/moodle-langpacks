...
/**
 * Strings for component 'data', language 'ja', branch 'MOODLE_30_STABLE'
 *
 * @package   data
...
$string['latlongboth'] = '緯度および経度の両方は必須です。';
...
$string['manageapproved_help'] = 'この設定を無効にした場合、認証済みエントリは追加したオーナーにより編集および削除することはできません。この設定は「承認必要」が有効にされない限り、影響を及ぼしません。';
