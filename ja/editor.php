...
$string['cutpastemozilla'] = '大変残念ですが、現在通常のキーボードショートカット (ペーストボタンも) を使用できません。これはMozillaおよびFirefoxブラウザのいくつかのバージョンにセキュリティ機能が組み込まれたことが原因しています。<br /><br />これに関して3つの対処方法があります: <br /> (1) CTRL + vを使用する代わりにSHIFT + Insertを使用する。<br /> (2) ブラウザの「編集->貼り付け」メニューを使用する。<br /> (3) user.jsファイルを編集してあなたのブラウザプリファレンスを変更する。<br /><br />ヘルプを表示するには下のOKボタンをクリックしてください。エディタに戻るにはキャンセルをクリックしてください。';
$string['delete'] = '削除';
