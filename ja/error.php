...
$string['alreadyloggedin'] = 'あなたはすでに {$a} としてログインしています。あなたは異なるユーザとしてログインする前にログアウトする必要があります。';
...
$string['cannotassignselfasparent'] = '自分自身を親カテゴリに割り当てできません!';
...
$string['cannotfindhelp'] = '「 {$a} 」言語ヘルプファイルを見つけることができません。';
...
$string['cannotgeoplugin'] = 'https://www.geoplugin.comのgeoPluginサーバに接続できません。プロキシ設定を確認するか、MaxMind GeoLite Cityデータファイルをインストールしてください。';
