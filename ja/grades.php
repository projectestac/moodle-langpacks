...
$string['fixedstudents_help'] = '学生カラムを見失わないよう、カラムを固定して評定の水平スクロールを許可します。';
...
$string['gradealreadyupdated'] = '評点インポートファイルが評定者レポートより古いため、{$a} 評点はインポートされませんでした。どうしても評点インポートを続行したい場合、強制インポートオプションを使用してください。';
...
$string['gradepointdefault_help'] = 'ここでは活動内で利用できる評点デフォルトを決定します。';
...
$string['gradevaluetoobig'] = '評点の1つが許可された最大評点  {$a} を超えています。';
...
$string['nopermissiontoresetweights'] = '加重をリセットするパーミッションがありません。';
...
$string['overridecat'] = 'カテゴリ評点の手動オーバーライド (優先) を許可する';
$string['overridecat_help'] = 'この設定を無効にした場合、ユーザがカテゴリ評点をオーバーライド (優先) することができなくなります。';
...
$string['overrideweightofa'] = '{$a} の加重をオーバーライド (優先) する';
...
$string['removeallcoursegrades_help'] = '有効にした場合、オーバーライドされた評点およびデータ、除外、非表示およびロックされた評点と共に評定表に手動追加された評定項目すべてが削除されます。活動と関連付けられている評点のみが保持されます。';
$string['removeallcourseitems'] = 'すべての評定項目およびカテゴリを削除する';
$string['removeallcourseitems_help'] = '有効にした場合、オーバーライドされた評点およびデータ、除外、非表示およびロックされた評点と共に評定表に手動追加されたカテゴリおよび評定項目すべてが削除されます。活動と関連付けられている評点のみが保持されます。';
$string['report'] = 'レポート';
...
$string['showcontributiontocoursetotal'] = 'コース合計への内訳を表示する';
$string['showcontributiontocoursetotal_help'] = 'それぞれの評定項目が (加重適用後に) ユーザのコース合計にどのくらい貢献しているかを示すパーセンテージのカラムを表示します。';
...
$string['userfields_show_help'] = 'メールアドレスのような追加的なユーザフィールドを評定レポートに表示します。表示される特定フィールドは「showuseridentity」サイト設定によりコントロールされます。';
