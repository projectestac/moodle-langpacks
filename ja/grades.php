...
$string['modgradecategorycantchangegradetypemsg'] = 'このカテゴリはオーバーライドされた評定アイテムに関連付けられています。いくつかはすでに評定済みのため、評定タイプは変更できません。最大評点を変更したい場合、あなたは最初に既存の評点を再計算するかどうか選択する必要があります。';
$string['modgradecategorycantchangegradetyporscalemsg'] = 'このカテゴリはオーバーライドされた評定アイテムに関連付けられています。いくつかはすでに評定済みのため、評定タイプおよび評価尺度は変更できません。';
