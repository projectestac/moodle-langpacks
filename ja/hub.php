...
$string['policyagreed'] = 'プライバシ通知およびデータ処理に関する同意書';
$string['policyagreeddesc'] = '私は<a href="{$a}" target="_blank">プライバシ通知およびデータ処理に関する同意書</a>に同意します。';
...
$string['siteurl_help'] = 'URLはこのサイトのアドレスです。プライバシ設定で人のサイトアドレス閲覧を許可している場合、このURLが使用されます。';
