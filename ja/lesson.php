...
/**
 * Strings for component 'lesson', language 'ja', branch 'MOODLE_30_STABLE'
 *
 * @package   lesson
...
$string['notenoughtimespent'] = 'あなたは所要時間 {$a->timerequired} より短い {$a->timespent} でレッスンを完了しました。あなたは再度レッスンを受験することができます。';
...
$string['numberofcorrectanswersheader'] = '正答数';
...
$string['prerequisiteisobsolete'] = '必修レッスンは削除される予定です。代わりにアクセス制限を使用してください。';
