...
$string['local_mobileurlscheme'] = 'これを設定すると、ブラウザのウインドウからログインする際にURLスキームの利用が強制されます。通常は、空欄のままにしておくべきです。';
$string['local_mobileurlscheme_key'] = 'URLスキーム';
$string['loginintheapp'] = 'アプリ経由';
$string['logininthebrowser'] = 'ブラウザ経由（SSOプラグイン用）';
$string['loginintheinappbrowser'] = '組込ブラウザ経由（SSOプラグイン用）';
$string['mainmenu'] = 'メインメニュー';
$string['mobilefeatures'] = 'モバイル機能';
$string['mod_scorm_protectpackagedownloads'] = 'パッケージダウンロードからの保護';
$string['mod_scorm_protectpackagedownloads_desc'] = 'これを有効にすると、SCORMパッケージのダウンロードは、ユーザがcourse:manageactivitiesケーパビリティを持つ場合に限りダウンロード可能となります。無効にすると、SCORMパッケージは（モバイルあるいは他の手段に関わらず）つねにダウンロード可能となります。';
$string['mod_scorm_settings'] = 'SCORMモバイル限定設定';
