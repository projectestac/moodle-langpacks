...
$string['show_in_course_lti1'] = '活動作成時に表示する';
$string['show_in_course_lti1_help'] = 'コースへの追加時の選択のため、このツールを活動チューザ内で教師に表示することができます。コースへの外部ツール追加時に事前設定ツールドロップダウンメニュー内にも表示することができます。

代わりにツール設定はフォームに表示されませんが、コースへの外部ツール追加時に正しい起動URLが入力された場合のみ使用されます。';
$string['show_in_course_lti2'] = '活動作成時に表示する';
...
$string['show_in_course_no'] = '表示しない、起動URLの合致のみに使用する';
