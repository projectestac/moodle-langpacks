...
$string['allow'] = 'このサービスをプライバシ設定を基にメンバシップ情報を検索するため使用します';
$string['ltiservice_memberships'] = 'IMS LTI氏名およびロールプロビジョニング:';
$string['ltiservice_memberships_help'] = 'IMS LTI氏名およびロールプロビジョニングサービスを利用してツールがコースからメンバ情報を検索できるようにします。プライバシ設定が適用されます。コースレベルのリクエストに関してはツール設定をベースにします。あなたが常にそのような詳細を送信したい場合、教師に選択権を与えないでください。リンクレベルは常にリンクに適用されるプライバシ設定を使用します。';
