...
$string['privacy:metadata:message_conversation_actions'] = '会話ユーザアクション一覧です。';
$string['privacy:metadata:message_conversation_actions:action'] = '実行されたアクションです。';
$string['privacy:metadata:message_conversation_actions:conversationid'] = 'このアクションが属する会話IDです。';
