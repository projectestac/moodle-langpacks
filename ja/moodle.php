...
/**
 * Strings for component 'moodle', language 'ja', branch 'MOODLE_30_STABLE'
 *
 * @package   moodle
...
$string['textediting_help'] = 'AttoまたはTinyMCEのようなHTMLエディタが選択された場合、コンテンツを簡単に追加できるよう、テキスト入力エリアにはボタンを含むツールバーが配置されます。
