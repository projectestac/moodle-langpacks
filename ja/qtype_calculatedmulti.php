...
$string['pluginname_help'] = '多肢選択計算問題は小テスト受験時に個別の値に置換される波括弧「{}」内のワイルドカードを使用する数値式を選択肢に含むことのできる多肢選択問題のような問題です。例えば「高さ {l} 、幅 {w} の長方形の面積は?」という問題があったとして、1つの選択肢は {={l}*{w}} ( * は乗算を意味します) のようにすることができます。';
