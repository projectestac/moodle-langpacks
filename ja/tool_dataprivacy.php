...
$string['automaticdatadeletionapproval_desc'] = 'この設定を有効にした場合、データ削除リクエストは自動的に承認されます。<br/>自動承認はこの設定が有効にされた後の新しいデータ削除リクエストにのみ適用されることに留意してください。既存の承認待ちのデータ削除リクエストはプライバシ責任者による手動承認が必要です。';
$string['automaticdataexportapproval'] = '自動データエクスポートリクエスト承認';
$string['automaticdataexportapproval_desc'] = 'この設定を有効にした場合、データエクスポートリクエストは自動的に承認されます。<br/>自動承認はこの設定が有効にされた後の新しいデータエクスポートリクエストにのみ適用されることに留意してください。既存の承認待ちのデータエクスポートリクエストはプライバシ責任者による手動承認が必要です。';
...
$string['cachedef_purpose_overrides'] = 'データプライバシツールのオーバーライド理由';
...
$string['contactdataprotectionofficer'] = 'プライバシ責任者に連絡する';
$string['contactdataprotectionofficer_desc'] = 'この設定を有効にした場合、ユーザはプライバシ責任者に連絡して自分のプロファイルページのリンクからデータをリクエストすることができます。';
$string['contactdpoviaprivacypolicy'] = 'プライバシポリシに記載されているプライバシ責任者にご連絡ください。';
...
$string['deprecatedexplanation'] = 'このプラグインは古いバージョンのプライバシインターフェースの1つを使用しているため更新してください。';
$string['download'] = 'ダウンロード';
$string['downloadexpireduser'] = 'ダウンロードの有効期限が切れました。あなたの個人データをエクスポートしたい場合、新しいリクエストを送信してください。';
$string['dporolemapping'] = 'プライバシ責任者ロールマッピング';
$string['dporolemapping_desc'] = 'プライバシ責任者はデータリクエストを管理することができます。ロールがプライバシ責任者ロールマッピングオプションとして一覧表示されるためにはケイパビリティ「tool/dataprivacy:managedatarequests」が許可される必要があります。';
...
$string['errorcontactdpodisabled'] = 'プライバシ責任者への連絡のオプションは無効にされています。';
...
{$a->backtrace}</pre>';
$string['exceptionnotificationsubject'] = 'プライバシデータの処理中に例外が発生しました。';
...
$string['markedcomplete'] = 'あなたの問い合わせはプライバシ責任者によって完了マークされました。';
...
$string['pluginname'] = 'データプライバシ';
$string['pluginname_help'] = 'データプライバシプラグイン';
$string['pluginregistry'] = 'プラグインプライバシレジストリ';
$string['pluginregistrytitle'] = 'プラグインプライバシ準拠レジストリ';
$string['privacy'] = 'プライバシ';
...
$string['privacy:metadata:request:dpocomment'] = 'リクエストに関してサイトのプライバシ責任者によって作成されたすべてのコメントです。';
...
$string['privacyofficeronly'] = 'プライバシ責任者ロール ({$a}) が割り当てられたユーザのみこのコンテンツにアクセスすることができます。';
...
$string['purposeoverview'] = '理由では保存済みデータの使用目的およびポリシの保持に関して説明します。データの保存および保持に関しても理由で説明されます。';
$string['purposes'] = '目的';
...
$string['requestsubmitted'] = 'あなたのリクエストがサイトのプライバシ責任者に送信されました。';
$string['requesttype'] = 'タイプ';
$string['requesttype_help'] = 'あなたがサイトのプライバシ責任者に連絡したい理由を選択してください。すべての個人データを削除した場合、あなたがサイトにログインできなくなることに注意してください。';
...
$string['requiresattentionexplanation'] = 'このプラグインにはMoodleプライバシAPIは実装されません。このプラグインが個人データを保存した場合、Moodleのプライバシシステムを経由で個人データをエクスポートまたは削除することはできません。';
...
$string['roleoverrideoverview'] = 'デフォルトの保持ポリシは特定のユーザロールの保持ポリシを長くまたは短くするようオーバーライドすることができます。これらすべてのロールが有効期限切れとなった場合のみユーザの有効期限が切れます。';
...
$string['user'] = 'ユーザ';
$string['userlistexplanation'] = 'このプラグインではベースプロバイダが提供されていますが、プライバシ機能のフルサポートのためユーザリストプロバイダも実装する必要があります。';
