...
$string['validationmsg_componentmismatchname_help'] = 'GitHubから生成されたZIPパッケージには、正しくないルートディレクトリ名が含まれている可能性があります。あなたは宣言されたプラグイン名に合致するよう、ルートディレクトリ名をリネームする必要があります。';
...
$string['validationmsg_rootdirinvalid_help'] = 'ZIPパッケージのルートディレクトリ名が形式的構文の要件に違反しています。GitHubから生成されたZIPパッケージには、正しくないルートディレクトリ名が含まれている可能性があります。あなたはプラグイン名に合致するよう、ルートディレクトリ名をリネームする必要があります。';
