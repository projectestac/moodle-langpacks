...
$string['pleaserefreshregistration'] = 'O seu site foi registado em moodle.org. Última atualização do registo: {$a}.<br />A tarefa agendada "Registo do site" mantém o registo atualizado. A qualquer momento pode atualizar o seu registo manualmente.';
$string['pleaserefreshregistrationunknown'] = 'O seu site foi registado, mas a data de registo é desconhecida.
Por favor, atualize o seu registo através do botão "Atualizar registo\' ou assegure-se que a tarefa agendada "Registo do site" se encontra ativa para que o registo seja atualizado automaticamente.';
