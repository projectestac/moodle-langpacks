...
$string['configextendedusernamechars'] = 'Se ativar esta opção os utilizadores poderão utilizar quaisquer caracteres nos seus nomes de utilizador (note que esta opção não afeta os nomes de utilizador atuais). Esta opção está desativada por predefinição o que limita os caracteres nos nomes de utilizador a caracteres alfanuméricos em minúsculas, underscore (_), hífen (-), ponto (.) e o símbolo arroba (@).';
...
$string['configmaxusersperpage'] = 'Número máximo de utilizadores a serem mostrados no selecionador de utilizadores no âmbito da disciplina, grupo, grupo global, web service, etc.';
...
$string['soaprecommended'] = 'A instalação da extensão opcional SOAP é útil para web services e alguns módulos.';
