...
$string['auth_changingemailaddress'] = 'Foi pedida uma alteração do e-mail, de {$a->oldemail} para {$a->newemail}. Por questões de segurança, é enviada uma mensagem para o novo e-mail para garantir que este lhe pertence. A alteração de e-mail terá efeito assim que abrir o URL enviado na mensagem. A hiperligação de confirmação expirará em <b>10 minutos</b>';
