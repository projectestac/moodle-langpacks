...
/**
 * Strings for component 'auth_cas', language 'pt', branch 'MOODLE_30_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_curl_ssl_version'] = 'A versão SSL (2 ou 3) para utilização. Por defeito o PHP determina esta questão automaticamente, no entanto, em alguns casos isto deverá ser definido manualmente.';
$string['auth_cas_curl_ssl_version_default'] = 'Por defeito';
