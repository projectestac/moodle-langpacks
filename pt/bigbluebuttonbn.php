...
$string['config_meetingevents_enabled_description'] = 'Se ativar esta opção, será possível aceitar e processar eventos ao vivo após o fim da sessão. (Este recurso é experimental e funcionará apenas se o servidor BigBlueButton for capaz de processar scripts \'post_events\')';
...
$string['config_recording_default'] = 'Funcionalidade de gravação ativa';
...
$string['config_recordings_imported_editable_description'] = 'Se ativar esta opção, a funcionalidade \'Mostrar apenas hiperligações importadas\' pode ser editada, por predefinição, quando a instância é adicionada ou atualizada.';
...
$string['mod_form_field_welcome_default'] = '<br>Bem-vindo(a) a <b>%%CONFNAME%%</b>!<br><br>Para compreender como funciona o BigBlueButton, veja os nossos <a href="event:http://www.bigbluebutton.org/content/videos"><u>vídeos explicativos</u></a>.<br><br>Para ativar a funcionalidade áudio clique no ícone dos auscultadores.<b> Por favor, use auscultadores para evitar incomodar as outras pessoas.</b>';
$string['mod_form_field_welcome_help'] = 'Substitui a mensagem configurada, por predefinição, para o servidor BigBlueButton. A mensagem pode incluir palavras-chave (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%), que serão automaticamente substituídas, e também tags HTML, tais como &lt;b&gt;...&lt;/b&gt; ou &lt;i&gt;...&lt;/i&gt; ';
...
$string['view_message_importrecordings_disabled'] = 'A função \'Importar hiperligação de gravação\' está desativada neste servidor.';
...
$string['view_message_recordings_disabled'] = 'As gravações foram desativadas neste servidor. Apenas as instâncias de gravação não podem ser utilizadas no BigBlueButton.';
...
$string['view_recording_button_import'] = 'Importar hiperligação de gravação';
