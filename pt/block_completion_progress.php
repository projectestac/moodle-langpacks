...
$string['completed_colour_descr'] = 'Código da cor HTML para elementos que já estão concluídos';
...
$string['futureNotCompleted_colour_descr'] = 'Código da cor HTML para futuros elementos que ainda não estão concluídos';
...
$string['how_group_works_help'] = '<p>Se selecionar um grupo, a exibição do bloco apenas será visível para o grupo escolhido.</p>';
...
$string['how_selectactivities_works_help'] = '<p>Para selecionar manualmente as atividades que pretende incluir na barra, garanta que a opção "Atividades incluídas" está definida para "Atividades selecionadas".</p><p>Podem ser incluídas apenas as atividades com verificação da conclusão definida.</p><p>Mantenha pressionada a tecla CTRL para selecionar várias atividades.</p>';
...
$string['not_all_expected_set'] = 'Nem todas as atividades com verificação da conclusão têm definida uma data de "{$a}".';
