...
$string['completionpercentgroup_help'] = 'Se for selecionado \'Percentagem de itens\', os utilizadores devem marcar pelo menos a percentagem especificada dos itens da lista de verificação para serem considerados \'concluídos\'. Se for selecionado \'Itens\', o utilizador deve marcar pelo menos esse número de itens individuais na lista. Tenha atenção que, se especificar aqui um número de itens maior do que o número de itens na lista de verificação, ele nunca será marcado como completo.';
