...
$string['enablelinebreakfilter_desc'] = 'Filtrar os títulos dos mosaicos para o {{#linebreak}} e, se presente e o título do mosaico for longo, substituir por "-" para permitir a quebra da linha. Caso contrário, não substitui (ou seja, não há quebra de linha).';
