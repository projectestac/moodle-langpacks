...
$string['arrow'] = 'Seta';
$string['attempted'] = 'Com tentativa de resposta';
$string['bulb'] = 'Lâmpada';
...
$string['coursesectionactivityfurtherinformationassigndesc'] = 'Mostrar informações do trabalho, tais como, a data limite de submissão. Aos professores/administradores será mostrado o número de submissões.';
$string['coursesectionactivityfurtherinformationchoice'] = 'Mostrar informação da sondagem';
$string['coursesectionactivityfurtherinformationchoicedesc'] = 'Mostrar informações da sondagem, tais como, o estado da submissão. Aos professores/administradores será mostrado o número de submissões.';
$string['coursesectionactivityfurtherinformationdata'] = 'Mostrar informação da base de dados';
$string['coursesectionactivityfurtherinformationdatadesc'] = 'Mostrar informações da base de dados, tais como, o estado da submissão. Aos professores/administradores será mostrado o número de submissões.';
$string['coursesectionactivityfurtherinformationfeedback'] = 'Mostrar informação do feedback';
$string['coursesectionactivityfurtherinformationfeedbackdesc'] = 'Mostrar informações do inquérito, tais como, o estado da submissão. Aos professores/administradores será mostrado o número de submissões.';
$string['coursesectionactivityfurtherinformationlesson'] = 'Mostrar informação da lição';
$string['coursesectionactivityfurtherinformationlessondesc'] = 'Mostrar informações da lição, tais como, o estado da submissão. Aos professores/administradores será mostrado o número de submissões.';
$string['coursesectionactivityfurtherinformationquiz'] = 'Mostrar informação do teste';
$string['coursesectionactivityfurtherinformationquizdesc'] = 'Mostrar informações do teste, tais como, o estado da submissão. Aos professores/administradores será mostrado o número de submissões.';
...
$string['draft'] = 'Não publicado para os alunos';
$string['due'] = 'Prazo: {$a}';
...
$string['notanswered'] = 'Não responderam';
$string['notattempted'] = 'Sem tentativa de resposta';
$string['notcontributed'] = 'Não contribuiu';
$string['notopen'] = 'Ainda não abriu';
$string['notsubmitted'] = 'Não submeteu';
...
$string['reopened'] = 'Reaberta';
$string['resetallcolour'] = 'Cores';
$string['resetallcolour_help'] = 'Repõe as cores e as opacidades para os valores predefinidos para todos as disciplinas e serão iguais aos da disciplina a primeira vez que está no formato Tópicos Contraídos.';
$string['resetalldisplayinstructions'] = 'Mostrar instruções';
$string['resetalldisplayinstructions_help'] = 'Repõe o valor predefinido da definição da exibição das instruções em todas  as disciplinas de modo a que este seja igual ao de uma nova disciplina com  o formato Tópicos Contraídos.';
$string['resetallgrp'] = 'Repor tudo:';
$string['resetalllayout'] = 'Estruturas';
$string['resetalllayout_help'] = 'Repõe o valor predefinido da estrutura, colunas, alternar tudo, ver secção única, posição do ícone, uma secção e o sumário da secção mostrado em todas as disciplinas, de modo a que este seja igual ao de uma nova disciplina com o formato Tópicos Contraídos.';
$string['resetalltogglealignment'] = 'Alinhamento dos botões';
$string['resetalltogglealignment_help'] = 'Repõe para o valor predefinido a definição do alinhamento dos botões em todas as disciplinas de modo a que este seja igual ao de uma nova disciplina com o formato Tópicos Contraídos.';
$string['resetalltoggleiconset'] = 'Ícones dos botões';
$string['resetalltoggleiconset_help'] = 'Repõe para o valor predefinido a definição dos ícones dos botões em todas  as disciplinas de modo a que este seja igual ao de uma nova disciplina com  o formato Tópicos Contraídos.';
$string['resetcolour'] = 'Cor';
$string['resetcolour_help'] = 'Repõe o valor predefinido da definição das cores e opacidade em todas  as disciplinas de modo a que este seja igual ao de uma nova disciplina com  o formato Tópicos Contraídos.';
$string['resetdisplayinstructions'] = 'Mostrar instruções';
$string['resetdisplayinstructions_help'] = 'Repõe o valor predefinido da definição da exibição das instruções de modo a que este seja igual ao de uma nova disciplina com o formato Tópicos Contraídos.';
$string['resetgrp'] = 'Repor:';
$string['resetlayout'] = 'Estrutura';
$string['resetlayout_help'] = 'Repõe para o valor predefinido a estrutura, colunas, alternar tudo, ver secção única, posição do ícone, uma secção e o sumário da secção mostrado em todas as disciplinas, de modo a que este seja igual ao de uma nova disciplina com o formato Tópicos Contraídos.';
$string['resettogglealignment'] = 'Alinhamento do botão';
$string['resettogglealignment_help'] = 'Repõe o valor predefinido da definição do alinhamento do botão de modo a que este seja igual ao de uma nova disciplina com o formato Tópicos Contraídos.';
$string['resettoggleiconset'] = 'Ícones do botão';
$string['resettoggleiconset_help'] = 'Repõe o valor predefinido da definição dos ícones do botão de modo a que este seja igual ao de uma nova disciplina com o formato Tópicos Contraídos.';
