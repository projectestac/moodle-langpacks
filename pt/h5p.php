...
$string['mainlibrarydisabled'] = 'Este ficheiro não pode ser exibido porque o tipo de conteúdo a que pertence está desativado. Entre em contacto com o administrador para solicitar a ativação do tipo de conteúdo.';
