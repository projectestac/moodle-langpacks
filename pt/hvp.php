...
$string['action'] = 'Ação';
$string['addedandupdatelibraries'] = 'Adicionadas {$a->%new} novas H5P bibliotecas e atualizadas {$a->%old} antigas.';
$string['addednewlibraries'] = 'Adicionadas {$a->%new} novas H5P bibliotecas.';
...
$string['ctcachedescription'] = 'Assegurar que a cache do tipo de conteúdo se encontra atualizada permite que possa visualizar, descarregar e usar as bibliotecas mais recentes. Isto é diferente da atualização das próprias bibliotecas.';
...
$string['hvp:getcachedassets'] = 'Obtenha recursos de conteúdo H5P em cache';
$string['hvp:getcontent'] = 'Obter/visualizar conteúdo do ficheiro H5P no curso';
$string['hvp:getexport'] = 'Obter ficheiro de exportação de H5P em curso';
$string['hvp:installrecommendedh5plibraries'] = 'Instalar as bibliotecas H5P recomendadas';
$string['hvp:restrictlibraries'] = 'Limitar uma biblioteca H5P';
$string['hvp:savecontentuserdata'] = 'Guardar dados do utilizador do conteúdo H5P';
$string['hvp:saveresults'] = 'Guardar resultado do conteúdo H5P';
$string['hvp:updatelibraries'] = 'Atualizar a versão de uma biblioteca H5P';
$string['hvp:userestrictedlibraries'] = 'Usar bibliotecas H5P restritas';
$string['hvp:viewallresults'] = 'Visualizar os resultados de todos os utilizadores no curso';
$string['hvp:viewresults'] = 'Visualizar resultado das próprias questões no curso';
...
$string['invalidlibrary'] = 'A biblioteca H5P {$a->%library} usada no conteúdo é inválida';
...
$string['lookforupdates'] = 'Procure por atualizações do H5P';
...
$string['successfullyregisteredwithhub'] = 'O seu site foi registado com sucesso com o H5P Hub.';
...
$string['welcomecommunity'] = 'Esperamos que goste do H5P e contribua com a crescente comunidade através do nosso <a {$a->forums}>forums</a> e sala de chat  <a {$a->gitter}>H5P at Gitter</a>';
