...
$string['teacherjumpwarning'] = 'Nesta lição, há páginas que seguem para {$a->cluster} ou para {$a->unseen}. Esta sequência será ignorada e a lição seguirá para a página seguinte. Para testar a sequência das páginas entre como aluno.';
