...
$string['idnumbercoursecategory_help'] = 'O número de identificação de uma categoria (ID) é usado apenas para comunicação com sistemas externos e não é exibido em nenhum parte do site. Se a categoria tem um código do nome oficial, este pode ser inserido, caso contrário, o campo pode ser deixado em branco.';
$string['idnumbergroup'] = 'Número de identificação do grupo';
$string['idnumbergroup_help'] = 'O número de identificação de um grupo (ID) é usado apenas para comunicação com sistemas externos e não é exibido em nenhuma parte do site. Se o grupo tem um código do nome oficial, este pode ser inserido, caso contrário, o campo pode ser deixado em branco.';
$string['idnumbergrouping'] = 'Número de identificação do agrupamento';
$string['idnumbergrouping_help'] = 'O número de identificação (ID) de um agrupamento é usado apenas para comunicação com sistemas externos e não é exibido em nenhuma parte do site. Se o agrupamento tem um código do nome oficial, este pode ser inserido, caso contrário, o campo pode ser deixado em branco.';
$string['idnumbermod'] = 'Número de identificação (ID)';
$string['idnumbermod_help'] = 'Definir um número de identificação (ID) é uma forma de identificar a atividade ou o recurso para fins de cálculo de notas ou relatórios personalizados. Se não for o caso, o campo pode ser deixado em branco.

Para atividades a serem avaliadas, o número de identificação (ID) também pode ser definido ao configurar a pauta, porém só pode ser editado na página de configurações da atividade.';
