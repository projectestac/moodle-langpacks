...
$string['attendanceoverview'] = 'Visão global';
...
$string['editgrades'] = 'Notas';
$string['editgradeslistitem'] = 'Total de pontos: {$a}';
...
$string['editquestionlistitem'] = '{$a} perguntas adicionadas';
...
$string['errorreport'] = 'Relatório dos erros da avaliação';
...
$string['importmailsubject'] = 'Notificação de avaliação do Teste Offline';
...
Os nomes dos ficheiros não são relevantes, mas não devem conter caracteres especiais, tais como ä. As imagens devem ser GIFs, PNGs ou TIFs. Recomenda-se uma resolução entre 200 e 300 dpi.</p>';
$string['importnumberexisting'] = 'Número de formulários duplicados: {$a}';
$string['importnumberpages'] = 'Número de páginas avaliadas com sucesso: {$a}';
$string['importnumberresults'] = 'Número de avaliados: {$a}';
...
$string['noattempts'] = 'Sem resultados disponíveis!';
...
$string['nopages'] = 'Nenhuma página avaliada';
...
$string['numattempts'] = 'Número de resultados avaliados: {$a}';
...
$string['numpages'] = '{$a} páginas avaliadas';
...
$string['otherresultexists'] = 'Já existe um resultado diferente para {$a}. A avaliação foi ignorada! Apague o resultado primeiro.';
...
$string['pagecorrected'] = 'Avaliada a folha com a lista de participantes corrigida';
$string['pageevaluationtask'] = 'Avaliação das folhas das respostas do Teste Offline';
$string['pageimported'] = 'Avaliada folha da lista de presenças';
$string['pagenotdetected'] = 'Não foi possível ler o código de barras da página!';
$string['pagenumberimported'] = 'Avaliada folha {$a} da lista de presenças';
...
$string['participantslist'] = 'Folha de presenças';
$string['participantslists'] = 'Participantes';
$string['partimportnew'] = 'A carregar folha de presenças';
$string['partimportnew_help'] = '<p>
Neste separador pode carregar e avaliar as folhas de presenças já preenchidas. Pode enviar um único ficheiro de imagem digitalizada ou vários ficheiros de imagens digitalizadas num ficheiro ZIP. O módulo de Teste Offline processará os ficheiros de imagem em segundo plano.
...
$string['question_created'] = 'A pergunta foi criada com sucesso';
$string['question_updated'] = 'A pergunta foi atualizada com sucesso';
...
$string['qversioncannotupdate'] = 'A pergunta não pode ser atualizada. A versão da pergunta não mudou.';
$string['qversionnumbersdiffer'] = 'O número de respostas difere entre a versão antiga e a nova. Isto levaria a inconsistências.';
$string['qversionupdated'] = 'Pergunta atualizada. A versão da pergunta mudou.';
...
$string['resultexists'] = 'Já existe o mesmo resultado para {$a}. Avaliação não foi considerada.';
$string['resultimport'] = 'Carregar & Corrigir';
$string['results'] = 'Visão global';
...
$string['tabattendancesoverview'] = 'Visão global';
...
$string['tabofflinequizupload'] = 'Carregar & Corrigir';
$string['tabparticipantlists'] = 'Folhas de presenças';
$string['tabparticipantscorrect'] = 'Corrigir';
$string['tabparticipantsupload'] = 'Carregar & Corrigir';
$string['tabpreview'] = 'Pré-visualização';
...
$string['tabresultsoverview'] = 'Visão global';
...
$string['uploadpart'] = 'Carregar & Corrigir';
...
$string['userimported'] = 'O utilizador {$a} foi avaliado';
...
$string['userpageimported'] = 'Página única avaliada para o utilizador {$a}';
$string['userswithoutresult'] = 'Utilizadores sem resultado:&nbsp;';
...
$string['zipok'] = 'Ficheiro ZIP carregado';
