...
$string['dropbackground'] = 'Imagem de fundo para onde são arrastados os marcadores';
$string['dropzone'] = 'Área para largar {$a}';
$string['dropzoneheader'] = 'Área para largar';
...
$string['formerror_nobgimage'] = 'Tem de selecionar uma imagem para usar como fundo para a área para largar os items';
$string['formerror_nofile'] = 'Tem de efetuar upload ou selecionar um ficheiro a usar aqui.';
...
$string['formerror_noimageselected'] = 'Tem de selecionar um item arrastável para ser a resposta correta para esta área.';
...
$string['label'] = 'Texto';
$string['nolabel'] = 'Sem texto de rótulo';
$string['pleasedraganimagetoeachdropregion'] = 'A sua resposta não está completa. Arraste um item para cada área assinalada.';
$string['pluginname'] = 'Arrastar e largar para imagem';
$string['pluginnameadding'] = 'Adicionar pergunta de Arrastar e largar para imagem';
$string['pluginnameediting'] = 'Editar pergunta de Arrastar e largar para imagem';
$string['previewareaheader'] = 'Pré-visualizar';
$string['refresh'] = 'Atualizar prévisualização';
$string['shuffleimages'] = 'Mudar a ordem dos items para arrastar cada vez que a pergunta é respondida';
