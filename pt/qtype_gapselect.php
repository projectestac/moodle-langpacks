...
/**
 * Strings for component 'qtype_gapselect', language 'pt', branch 'MOODLE_30_STABLE'
 *
...
$string['combinedcontrolnamegapselect'] = 'Caixa de seleção';
$string['combinedcontrolnamegapselectplural'] = 'Caixas de seleção';
...
$string['pluginname_help'] = 'As perguntas do tipo selecionar palavras em falta necessitam que os alunos selecionem opções a partir de menus de seleção. [[1]], [[2]], [[3]], ... são utilizados como espaços reservados no texto da pergunta, com as respostas corretas especificadas como opções de resposta 1, 2, 3, ... respetivamente. Caso pretenda aumentar o grau de dificuldade da pergunta deverá adicionar opções de resposta extra. As opções de resposta poderão ser agrupadas para restringir as opções disponíveis em cada menu de seleção.';
$string['pluginnamesummary'] = 'As palavras em falta no texto de uma pergunta são preenchidas através de menus de seleção.';
