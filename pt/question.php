...
$string['categorymove'] = 'A categoria {$a->name} contém {$a->count} perguntas. (algumas podem ser antigas, estar ocultas ou em uso noutros testes). Por favor, escolha outra categoria de destino.';
