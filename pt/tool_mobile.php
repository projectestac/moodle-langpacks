...
$string['qrsiteadminsnotallowed'] = 'Por motivos de segurança, a autenticação via código QR não é permitido para administradores do site ou se estiver autenticado como outro utilizador.';
