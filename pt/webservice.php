...
$string['testwithtestclientdescription'] = 'Simule o acesso externo ao serviço usando o cliente de teste dos web services. Antes de o fazer, autentique-se como um utilizador com a capacidade moodle/webservice:createtoken e obtenha a chave de segurança (token) via as configurações do Meu perfil. Vai usar este token no cliente de testes. No cliente de teses, selecione também um protocolo com a autenticação token. <strong>AVISO: Os testes devem ser criteriosamente escolhidos porque as funções invocadas no teste serão EFECTIVAMENTE realizadas por este utilizador no sistema.</strong>';
$string['token'] = 'Token';
...
$string['wsaccessuserdeleted'] = 'Foi recusado o acesso ao web service para o utilizador apagado: {$a}';
$string['wsaccessuserexpired'] = 'Foi recusado o acesso ao web service para o nome de utilizador com a senha expirada: {$a}';
