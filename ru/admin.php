...
/**
 * Strings for component 'admin', language 'ru', branch 'MOODLE_30_STABLE'
 *
 * @package   admin
...
$string['alternativefullnameformat_desc'] = 'Параметр определяет, как пользователям с возможностью «viewfullnames» (по умолчанию пользователи с ролью управляющего, учителя или ассистента) отображаются имена. Подстановки, которые могут быть использованы, такие же, как для параметра «Формат полного имени».';
...
$string['mypage'] = 'Настройки по умолчанию страницы «Моя домашняя страница»';
