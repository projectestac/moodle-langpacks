...
$string['configfilteruploadedfiles'] = 'Обрабатывать фильтрами перед выводом на экран - все загруженные HTML и текстовые файлы, только загруженные HTML-файлы или вообще ничего не обрабатывать.';
...
$string['downloadcoursecontentallowed'] = 'Доступна функция скачивания содержимого курса';
