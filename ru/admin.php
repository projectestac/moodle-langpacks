...
$string['filescleanupperiod_help'] = 'Как часто удаляются файлы из корзины. Это файлы, которые связаны с контекстом, который больше не существует, например, когда курс удален. Обратите внимание: этот параметр может привести к отсутствию файлов в курсе, для которого выполняется резервное копирование, удаление и последующее восстановление, если параметр «Включить файлы» (backup_auto_files) в «Настройках автоматического резервного копирования» отключен.';
