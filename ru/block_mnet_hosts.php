...
/**
 * Strings for component 'block_mnet_hosts', language 'ru', branch 'MOODLE_30_STABLE'
 *
...
$string['mnet_hosts:myaddinstance'] = 'Добавлять новый блок «Сайты сети MNet» в «Моя домашняя страница»';
