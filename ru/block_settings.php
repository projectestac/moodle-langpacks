...
/**
 * Strings for component 'block_settings', language 'ru', branch 'MOODLE_30_STABLE'
 *
...
$string['settings:myaddinstance'] = 'Добавлять новый блок «Настройки» в «Моя домашняя страница»';
