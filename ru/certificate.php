...
/**
 * Strings for component 'certificate', language 'ru', branch 'MOODLE_28_STABLE'
 *
 * @package   certificate
...
$string['borderblack'] = 'Чёрный';
$string['borderblue'] = 'Синий';
$string['borderbrown'] = 'Коричневый';
$string['bordergreen'] = 'Зеленый';
$string['borderlines'] = 'Линии';
$string['borderstyle'] = 'Изображение границы';
...
$string['entercode'] = 'Для подтверждения введите код сертификата:';
$string['getcertificate'] = 'Получить сертификат';
$string['imagetype'] = 'Тип изображения';
$string['incompletemessage'] = 'Для того, чтобы скачать сертификат, необходимо сначала завершить все необходимые мероприятия. Пожалуйста, вернитесь в курс и закончите работу.';
$string['intro'] = 'Инструкция';
$string['issued'] = 'Выдан';
$string['issueddate'] = 'Дата выдачи';
$string['landscape'] = 'Альбомный';
$string['letter'] = 'Буква';
...
$string['notfound'] = 'Номер сертификата не может быть проверен.';
$string['notissued'] = 'Не выдается';
$string['notissuedyet'] = 'Еще не выдается';
...
$string['openemail'] = 'Нажмите на кнопку ниже, и сертификат будет отправлен Вам в виде вложения электронной почты.';
$string['openwindow'] = 'Нажмите на кнопку ниже, чтобы открыть свой сертификат в новом окне браузера.';
$string['or'] = 'или';
$string['pluginname'] = 'Сертификат';
$string['portrait'] = 'Книжный';
