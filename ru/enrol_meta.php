...
/**
 * Strings for component 'enrol_meta', language 'ru', branch 'MOODLE_30_STABLE'
 *
 * @package   enrol_meta
...
$string['meta:config'] = 'Настраивать экземпляры способа записи на курс «Связь метакурса»';
$string['meta:selectaslinked'] = 'Выбирать курс в качестве родительского в способе записи на курс «Связь метакурса»';
...
$string['pluginname'] = 'Связь метакурса';
$string['pluginname_desc'] = 'Метод записи «Связь метакурса» синхронизирует учащихся и роли в двух разных курсах';
