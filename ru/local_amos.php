...
/**
 * Strings for component 'local_amos', language 'ru', branch 'MOODLE_27_STABLE'
 *
 * @package   local_amos
...
$string['contribnotifcommented'] = 'Пользователь {$a->fullname} оставил комментарий по поводу Вашего вклада в перевод №{$a->id} «{$a->subject}»
---------------------------------------------------------------------
