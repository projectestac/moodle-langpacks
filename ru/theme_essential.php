...
/**
 * Strings for component 'theme_essential', language 'ru', branch 'MOODLE_28_STABLE'
 *
...
<h4>PayPal</h4>
<p>Пожалуйста, свяжитесь со мной через мой <a href="http://moodle.org/user/profile.php?id=442195" target="_blank">профиль в Moodle</a> для получения подробностей, так как я частное лицо и по правилам PayPal не могу размещать кнопки \'donation\' / \'buy me now\'.</p>
<h4>Flattr</h4>
<a href="https://flattr.com/profile/gjb2048" target="_blank">
Пройдите по этой ссылке для пожертвования.
</a>
<br>Пожертвования могут позволить мне быстрее предоставить вам новые возможности и улучшения  темы.</p>
</div></div>';
...
$string['credit'] = 'Тема Essential разработана, развивается и поддерживается следующими людьми:';
...
$string['donate_desc'] = 'Пожалуйста, внесите пожертвования через PayPal, связавшись со мной';
...
$string['paypal_desc'] = '{$a->url}\' для получения подробностей, так как я частное лицо и по правилам PayPal не могу размещать кнопки \'donation\' / \'buy me now\', или';
