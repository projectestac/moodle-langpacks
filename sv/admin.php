...
$string['configallowoverride2'] = 'Välj vilken roll/vilka roller som kan åsidosättas av respektive roll i vänstra kolumnen.<br />Notera att dessa inställningar endast är applicerbar på användare som antingen har funktionsbehörigheten moodle/role:override eller moodle/role:safeoverride.';
...
$string['configenablerssfeeds'] = 'Den här omkopplaren kommer att aktivera RSS-flöden från hela webbplatsen. För att faktiskt se några förändringar så behöver du aktivera RSS-flöden i de individuella modulerna också - gå till inställningar för moduler i Administration->konfiguration';
$string['configenablerssfeedsdisabled'] = 'Detta är inte tillgängligt eftersom RSS-flödena är inaktiverade på hela webbplatsen. För att aktivera dem behöver du gå till Administrera webbplats->Avancerade egenskaper';
$string['configenablerssfeedsdisabled2'] = 'RSS-flöden är inaktiverade på servernivå. Du måste först aktivera dem i Webbplatsadministrationen.';
...
$string['configextendedusernamechars'] = 'Aktivera den här inställningen för att låta studenter att använda vilka tecken de vill i sina användarnamn (lägg märke till att detta inte påverkar deras riktiga namn). Standardvalet är "falskt" vilket innebär att man bara kan använda små alfanumeriska tecken, understrykning (_), bindestreck (-), punkt (.) eller snabel-a (@).';
...
$string['debug'] = 'Meddelanden för felsökning';
...
$string['debugdisplay'] = 'Visa meddelanden för felsökning';
...
$string['environmentrecommendinstall'] = 'bör vara installerat och aktivt för bästa resultat';
...
$string['langpackwillbeupdated'] = 'N.B. Moodle kommer att försöka hämta uppdateringar för dina språkpaket under uppgraderingen.';
...
$string['myprofile'] = 'Standardprofilsida';
...
$string['showuseridentity_desc'] = 'Vid val eller sökning efter användare, och när listor över användare visas, kan dessa fält visas utöver deras fullständiga namn. Fälten visas bara för användare som har funktionsbehörigheten moodle/site:viewuseridentity; som standard, lärare och administratörer. (Det här alternativet är mest meningsfullt om du väljer ett eller två fält som är obligatoriska på din institution.)';
...
$string['sitepolicies'] = 'Säkerhetsinställningar för webbplats';
...
$string['sitepolicyhandler_desc'] = 'Detta avgör hur principer och användarsamtycken hanteras. Standardhanteraren (core) gör det möjligt att ange en webbadress för webbplatspolicyn och en webbadress för webbplatspolicyn för gäster. Policyhanteraren gör det möjligt att ange policys för webbplats, integritet samt andra policys. Den gör det också möjligt att se användarnas samtycken och vid behov ge samtycke för minderårigas räkning.';
...
$string['toolsmanage'] = 'Hantera adminverktyg';
...
$string['updateavailableforplugin'] = 'Det finns en nyare version tillgänglig för några av dina pluginmoduler.';
