...
$string['profilevisibleteachers'] = 'Synlig för användare, lärare och administratörer';
...
$string['updateavailable'] = 'Nu finns en nyare version av Moodle att hämta';
...
$string['updateavailablerecommendation'] = 'Du bör uppdatera Moodle till den här versionen för att få de senaste säkerhetsuppdateringarna och buggfixarna.';
