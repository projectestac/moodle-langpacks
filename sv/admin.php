...
$string['emoticons'] = 'Emojis';
$string['emoticons_desc'] = 'Detta formulär definierar emojis (eller smileys) som används på din webbplats. För att ta bort en rad ur tabellen, spara formuläret med ett tomt värde i något av de efterfrågade fälten. För att registrera nya emojis, fyll i fälten i den sista tomma raden. För att återställa alla fält till förvalda värden följ länken ovan.

* Text (krävs) - Denna text kommer att ersättas med emojibilden. Den måste vara minst två tecken.
* Bildnamn (krävs) - emojibildfilens namn, utan filändelse, relativt sökvägen till komponentens pix katalog.
* Bild (krävs) - Den bildfil som innehåller ikonen.
* Alternativ text (tillval) - Strängidentifierare och del av den alternativa texten för emojin.';
...
$string['moodleservices'] = 'Moodle-tjänster';
$string['moodleservices_help'] = 'Se till att du får ut det bästa av din lärmiljö i Moodle genom att använda dessa Moodle-tjänster:';
...
$string['searchallavailablecourses_on'] = 'Sök i alla kurser användaren har tillgång till';
