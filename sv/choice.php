...
/**
 * Strings for component 'choice', language 'sv', version '3.8'.
 *
 * @package     choice
 * @category    string
...
$string['eventanswercreated'] = 'Val genomfört';
...
$string['indicator:cognitivedepth'] = 'Val kognitiv';
$string['indicator:cognitivedepth_help'] = 'Denna indikator baseras på det kognitiva djup som uppnåtts av studenten i en Valaktivitet.';
$string['indicator:socialbreadth'] = 'Val social';
$string['indicator:socialbreadth_help'] = 'Denna indikator baseras på den sociala bredd som uppnåtts av studenten i en Valaktivitet.';
$string['indicator:socialbreadthdef_help'] = 'Deltagaren har nått denna procentandel av det sociala engagemanget som erbjuds av Valaktiviteterna under detta analysintervall (Nivåer = Inget deltagande, Deltagaren ensamt, Deltagaren tillsammans med andra)';
...
$string['modulename_help'] = 'Modulen opinionsundersökning gör det möjligt för distansläraren att ställa en fråga och ange flera svarsalternativ.';
...
$string['publishafterclose'] = 'Visa resultaten för respondenterna först efter det att opinionsundersökningen är avslutad';
$string['publishalways'] = 'Visa alltid resultaten för respondenterna';
$string['publishanonymous'] = 'Publicera anonyma resultat, visa inte respondenternas namn.';
