...
$string['activitiescompletednote'] = 'Notera: Slutförande av aktivitet måste aktiveras för en aktivitet för att den ska synas i ovanstående listan.';
...
$string['all'] = 'Allt';
$string['any'] = 'Vilken/vilka som anges';
...
$string['badautocompletion'] = 'När du väljer automatisk markering av slutförande, måste du även ställa in minst ett kriterium (nedan).';
$string['badcompletiongradeitemnumber'] = 'Kräv resultat kan inte aktiveras för <b>{$a}</b> eftersom bedömning av {$a} inte är aktiverad.';
$string['bulkactivitycompletion'] = 'Massredigera slutförande av aktivitet';
$string['bulkactivitydetail'] = 'Välj de aktiviteter du vill massredigera.';
$string['bulkcompletiontracking'] = 'Spåra fullföljande';
$string['bulkcompletiontracking_help'] = '<strong>Ingen:</strong> Ange inte något status för slutförande av aktiviteten

<strong>Manuell:</strong> Deltagare kan manuellt markera aktiviteten som slutförd
...
$string['completion'] = 'Spårning av slutförande';
...
$string['completion-n'] = 'Inte slutförd';
...
$string['completion_automatic'] = 'Visa aktivitet som slutförd när kriterier är uppnådda.';
...
$string['completiondefault'] = 'Grundinställning för spårning av slutförande';
...
$string['completionusegrade_help'] = 'Om denna inställning aktiveras anses aktiviteten slutförd då kursdeltagare får ett resultat/betyg. Godkänd-/underkändsymboler visas om en godkänd-nivå är inställd.';
$string['completionview'] = 'Begär granskning';
$string['completionview_desc'] = 'Studenten måste öppna den här aktiviteten för att slutföra den';
$string['configcompletiondefault'] = 'Standardinställning för spårning av slutförande när nya aktiviteter skapas';
$string['configenablecompletion'] = 'Om aktiverad kan slutförandevillkor för kurs- och aktivitet ställas in. Inställning av villkoren för slutförande av aktivitet rekommenderas så att meningsfulla data visas för användare i deras kursöversikt på Instrumentpanelen.';
...
$string['criteriarequiredany'] = 'Något av kriterierna nedan är krävs';
...
$string['defaultcompletion'] = 'Förvalt villkor för slutförande av aktivitet';
...
$string['editcoursecompletionsettings'] = 'Redigera inställningar för slutförande av kurs';
$string['enablecompletion'] = 'Aktivera spårning av slutförande';
$string['enablecompletion_help'] = 'Om aktiverad, måste villkor för genomförande av aktivitet anges i aktiviteten och/eller måste villkor för kursgenomförande anges.';
...
$string['err_nocourses'] = 'Spårning av fullföljande av kurs är inte aktiverad för någon annan kurs, så detta kan inte visas. Du kan aktivera spårning av fullföljande av kurs under kursens inställningar.';
$string['err_nograde'] = 'En betygsgräns för godkännande i kursen har inte angivits. För att aktivera detta kriterium måste du ange en betygsgräns för godkännande i denna kurs.';
$string['err_noroles'] = 'Det finns inga roller med behörigheten moodle/course:markcomplete i den här kursen.';
$string['err_nousers'] = 'Det finns inga kursdeltagare i den här kursen eller gruppen för vilka genomförandeinformation visas. (Som förinställning visas genomförandeinformation bara för kursdeltagare, så om kursen inte har några deltagare ser du detta meddelande. Administratörer kan ändra den inställningen i administrationsgränssnittet.)';
...
$string['eventcoursemodulecompletionupdated'] = 'Slutförandeinformation för kursaktivitet uppdaterad';
...
$string['manualcompletionbynote'] = 'OBS!: Behörigheten moodle/course:markcomplete måste tillåtas för att en roll ska synas i listan.';
...
$string['progress'] = 'Kursdeltagares framsteg';
...
$string['restoringcompletiondata'] = 'Skriver data för slutförande';
...
$string['unit'] = 'Enhet';
$string['unlockcompletion'] = 'Lås upp inställningar för slutförande';
$string['unlockcompletiondelete'] = 'Lås upp inställningar för slutförande och radera användarnas slutförandedata';
...
$string['writingcompletiondata'] = 'Skriver data om slutförande';
