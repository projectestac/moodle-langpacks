...
$string['editcoursecompletionsettings'] = 'Redigera slutförandeinställningar för kurs';
...
$string['err_settingslocked'] = 'En eller flera elever har redan uppfyllt ett kriterium och därför har inställningarna låsts. Om du låser upp inställningarna för slutförandekriterierna tas alla befintliga användardata bort och det kan orsaka förvirring.';
