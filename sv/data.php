...
$string['configenablerssfeeds'] = 'Den här omkopplaren kommer att aktivera möjligheten att välja RSS-flöden för alla databaser. Du måste ändå aktivera matningar manuellt i inställningarna för varje enskild databas.';
...
$string['requiredentries'] = 'Bidrag som är obligatoriska för fullföljande';
...
$string['rows'] = 'Rader';
$string['rssglobaldisabled'] = 'Inaktiverad. Kontrollera hur webbplatsens variabler är inställda.';
