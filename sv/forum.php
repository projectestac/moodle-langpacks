...
$string['maxattachmentsize_help'] = '<p>Den person som har satt upp ett forum kan sätta begränsningar
för hur stora de bifogade filerna får vara. </p>
<p>Ibland är det möjligt att ladda upp en fil som överskrider denna
...
$string['modenested'] = 'Visa svar i trådform';
$string['modenestedv2'] = 'Visa svar i trådform (experimentell)';
...
$string['myprofileotherdis'] = 'Diskussioner i forum';
...
$string['overviewnumunread'] = 'olästa inlägg';
...
$string['subscriptiondisabled'] = 'Prenumeration inte till&aring;ten';
...
$string['unreadpostsnumber'] = 'olästa inlägg';
