...
$string['enableoutcomes_help'] = 'Om aktiverad kan betygsobjekt bedömas med hjälp av en eller flera skalor knutna till resultat.';
...
$string['gradeitemsinc'] = 'Betygskomponenter som ska tas med';
...
$string['iteminfo'] = 'Komponentinformation';
...
$string['mappings'] = 'Mappning av betygskomponenter';
...
$string['newitem'] = 'Ny betygskomponent';
...
$string['notteachererror'] = 'Du måste vara lärare för att kunna använda det här';
