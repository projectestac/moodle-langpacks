...
$string['addgradeletter'] = 'Lägg till en betygsbokstav';
...
$string['calculatedgrade'] = 'Kalkylerat betyg';
...
$string['categorytotalfull'] = 'Sammanlagt {$a->category}';
...
$string['contract'] = 'Kontraktskategori';
...
$string['coursegradesettings'] = 'Inställningar för kursbetyg';
...
$string['exportplugins'] = 'Exportera pluginmoduler';
...
$string['gradebookhiddenerror'] = 'Betygsboken är f.n. inställd till att dölja allt för studenterna.';
...
$string['gradeexport'] = 'Export av betyg';
...
$string['gradeitem'] = 'Betygskomponent';
...
$string['gradeoutcomescourses'] = 'Resultat för kurs';
...
$string['hideforcedsettings'] = 'Dölj inställningar för tvinga';
$string['hideforcedsettings_help'] = 'Visa inte inställningarna för tvinga i användargränssnittet vid betygssättning.';
...
$string['importplugins'] = 'Importera pluginmoduler';
...
$string['overridden_help'] = '<p>När detta är aktiverat så kommer flaggan för åsidosättanden att förhindra framtida försök att automatiskt modifiera värdet på betyget. Den här flaggan ställs ofta in internt av betygskatalogen men du kan aktivera eller inaktivera den manuellt genom att använda den här komponenten i formuläret. </p>';
$string['overriddennotice'] = 'Ditt sammanfattningsbetyg för den här aktiviteten har justerats manuellt.';
$string['overridesitedefaultgradedisplaytype'] = 'Psidosätt de förvalda standardvärdena för webbplatsen';
...
$string['showquickfeedback_help'] = 'Snabb återkoppling lägger till en streckad ruta för varje betyg/resultat i betygsrapporten. Den låter dig redigera återkopplingen för många betyg samtidigt. Du kan sedan klicka på knappen Uppdatera för att genomföra alla dessa ändringar på en gång i stället för en i taget.

OBS När man ändrar resultatet i betygsrapporten sätt en liten överridit-flagga. Den innebär att återkopplingen/resultatet inte längre kan ändras inifrån aktiviteten utan bara i betygsrapporten.';
...
$string['upgradedgradeshidemessage'] = 'Avfärda notis';
