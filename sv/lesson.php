...
$string['casesensitive'] = 'Använd reguljärt uttryck';
...
$string['handlingofretakes_help'] = '<p>När studenterna får tillåtelse att göra om lektionen så gör det här alternativet det möjligt för kursansvarig att visa betygen/omdömena för lektionen t ex på betygs/ omdömessidan antingen som \'medelbetyget\' av det första och efterföljande försök eller som det \'högsta\' betyget som uppnåtts under försöken. </p> <p>Du kan ändra det här alternativet när som helst.</p>';
$string['havenotgradedyet'] = 'Har inte satt betyg än.';
$string['here'] = 'här';
$string['highscore'] = 'Högtstaresultat';
...
$string['lowscore'] = 'Lägstaresultat';
...
$string['maximumnumberofanswersbranches_help'] = '<p>Det här värdet avgör det maximala antalet svar som läraren kan använda. Det förinställda standardvärdet är 4. Om lektionen bara använder, säg, SANT och FALSKT-frågor genomgående, då är det rimligt att ställa in detta värde till 2. </p> <p>Den här parametern ställer även in det maximala antalet förgreningar som kan användas i tabellen för förgreningar.</p> <p>Du kan lugnt ändra värdet på den här parametern i en lektion som redan har ett innehåll. Faktum är att om Du vill lägga till en fråga med många svarsalternativ eller en lång förgreningstabell så måste Du ändra det här värdet. Efter det att Du har lagt till den (ovanliga) frågan eller förgreningstabellen så kan Du återställa det här värdet till ett mer "standardmässigt" värde.</p>';
$string['maximumnumberofattempts'] = 'Maximalt antal försök';
$string['maximumnumberofattempts_help'] = '<p>Det här värdet anger det maximala antalet gånger som en student får försöka besvara <b>någon</b> fråga vilken som helst i lektionen. I de fall där det inte ingår svarsalternativ i frågorna som t ex kortsvarsfrågor och numeriska frågor så tilhandahåller det här värdet en nödvändig <i>"escape"-rutin</i> till nästa fråga i lektionen. </p> <p>Standardvärdet är 5. Mindre värden kan minska studenternas intresse för att tänka på frågorna. Större värden kan leda till mer frustration.</p> <p>Om Du ställer in det här värdet till bara 1 så kan frågan bara besvaras en gång. Då blir det en uppgift av samma typ som med modulen Test förutom det att frågorna presenteras på individuella sidor.</p> <p>Lägg märke till att det här värdet är en global parameter vilket innebär att den gäller för alla frågor i lektionen oavsett typ.</p> <p>Lägg även märke till att den här parametern <b>inte</b> går att tillämpa på lärare som kollar frågorna eller navigerar genom lektionen. Att kontrollera antalet försök beror på värden som är lagrade i databasen och (distans)lärares försök att besvara frågorna registreras inte. Som lärare förväntas Du förstås veta svaren!</p>';
...
$string['modattempts'] = 'Tillåt studenter att se igen';
...
$string['modattemptsnoteacher'] = 'Upprepad visning för studenter fungerar bara för dem.';
...
$string['overview_help'] = '<ol> <li>En lektion är uppbyggd av ett antal <b>sidor</b> och som valfri möjlighet av <b>förgreningstabeller</b>.</li> <li>En sida har ett visst <b>innehåll</b> och den avslutas normalt sett med en <b>fråga</b>. Därav begreppet <b>Frågesidan</b>.</li> <li>Varje sida har normalt sett en uppsättning <b>svar</b>. </li> <li>Varje svar kan visa ett kort stycke text efter det att användaren har valt ett svar. Detta stycke kallas för <b>återkoppling</b>.</li> <li>Något som också är kopplat till varje sida är ett <b>hopp</b>. Hoppet kan vara relativt - den här sidan, nästa sida eller absolut. Om det är absolut så refererar det till vilken som helst av sidorna i lektionen eller lektionens slut.</li> <li>Som standard så hoppar det första "rätta" svaret till <b>nästa sida</b> i lektionen. De därpå följande svaren hoppar till samma sida. Dvs att för studenten visas samma sida i lektionen igen om de inte väljer det första "rätta" svaret.</li> <li>Vad som är nästa sida avgörs av lektionens <b>logiska följd</b>. Det är den följd som konstruktören har arrangerat sidorna i. Du kan ändra på den följden genom att flytta sidor inom lektionen.</li> <li>Lektionen har också en <b>navigationsföljd</b>. Det är den följd som studenterna ser sidorna i. Detta avgörs av de hopp som är angivna för varje individuellt svar och denna följd kan skilja sig mycket från den logiska följden. (Även om standardvärdena för hoppen <i>inte</i> har ändrats så är de två starkt relaterade till varandra.) Som konstruktör har Du alternativet att markera navigationsföljden.</li> <li>När svaren visas för studenterna så är de vanligtvis blandade. Dvs, det första svaret som Du anger behöver inte nödvändigtvis vara det första svar som visas för studenterna. (Vidare så är det så att svaren kommer att visas i en ny följd varje gång.) Undantaget från detta är uppsättningar av svar på frågor av typen para-ihop. Här visas nämligen svaren i samma följd som Du som konstruktör har angivit.</li> <li>Antalet svar kan variera från sida till sida. Det går t ex att låta några sidor sluta med en SANT/FALSKT-fråga medan andra har frågor med ett korrekt svar och, säg tre, felaktiga. </li> <li>Det är möjligt att skapa en sida utan svar. Studenterna får då se en <b>Fortsätt</b>-länk istället för en uppsättning blandade svar.</li> <li>I syfte att sätta betyg/omdömen på lektioner så är <b>korrekta</b> svar sådana som är hoppar till en sida som är längre <i>ner</i> i den logiska följden än den aktuella sidan. <b>Felaktiga</b> svar är sådana som antingen hoppar till samma sida eller till en sida som är längre <i>upp</i> i den logiska följden än den aktuella sidan. Sålunda är det så att om hoppen <i>inte</i> ändras så är det första svaret det som är korrekt och de andra svaren är felaktiga.</li> <li>Frågor kan ha mer än ett korrekt svar. Om t ex två av svaren hoppar till nästa sida då är båda godkända som korrekta svar. (Även om samma målsida visas för studenterna så kan den återkoppling som visas på vägen till denna sida mycket väl vara olika för de två olika svaren.)</li> <li>På den (lektions)sida som visas för läraren så har de korrekta svaren svarsetiketter som är understrukna.</li> <li><b>Förgreningstabeller</b> är helt enkelt sidor som har en uppsättning länkar till andra sidor i lektionen. Det vanliga är att en lektion inleds med en förgreningstabell som fungerar som en <b>Tabell över innehåll</b>.</li> <li>Varje länk i en förgreningstabell har två komponenter, en beskrivning och och titeln på sidan länken ska hoppa till. </li> <li>En förgreningstabell delar effektivt in lektionen i ett antal <b>förgreningar</b> (eller sektioner). Varje förgrening kan innehålla ett antal sidor (som antagligen relaterar till samma ämne). Slutet på förgreningen är vanligtvis markerad med en <b>Slut på förgrening</b>-sida. Det här är en speciell sida som, som standard, tar studenten tillbaka till den föregående förgreningstabellen. "tillbaka"-hoppet på en Slut-på-förgreningen-sida kan Du, om det behövs, ändra genom att redigera sidan. </li> <li>Det kan finnas mer än en förgreningstabell i en lektion. En lektion kan t ex vara användbart strukturerad så att fördjupningar och specialfall läggs in i under-förgreningar inom huvudämnets förgreningar.</li> <li>Det är viktigt att studententerna har möjligheter att avsluta lektionen. Detta kan t ex ske genom att Du tar med en länk för att "Avsluta lektionen" i den övergripande förgreningen. Detta gör att användaren hoppar till en (tänkt) sida för <b>Slut på lektionen</b>. En annan möjlighet är att den sista förgreningen i lektionen (här används "sista" i meningen logisk ordning) helt enkelt fortsätter till slutet på lektionen, dvs, den avslutas <i>inte</i> med en Slut-på-förgreningen-sida.</li> <li>När en lektion innehåller mer än en förgreningstabell så bör Du ställa in parametern "Minimalt antal frågor" till ett rimligt värde. Detta anger en lägre gräns för det antal sidor som räknas in när betyget/omdömet beräknas. Utan denna parameter skulle studenten kunna gå igenom en enskild förgrening i lektionen, besvara alla frågorna där korrekt och sedan lämna lektionen och få ut ett maximalt betyg/omdöme för hela lektionen.</li> <li> Vidare, när en förgreningstabell finns tillgänglig så har en student möjlighet att gå igenom samma förgrening flera gånger. Det är dock så att betyget/omdömet beräknas genom att man använder antalet <i>unika</i> frågor som är besvarade. Att man svarar flera gånger på samma uppsättning frågor höjer alltså inte betyget/omdömet. I själva verket är det tvärtom så att det sänker betyget/omdömet eftersom räknaren av visade sidor används i nämnaren när beräkningen av betyg/omdömen inkluderar flerfaldig visning av sidor. I syfte att ge studenterna en rimlig uppfattning om hur de presterar under lektionens gång så får de, på varje förgreningstabell, se detaljer angående hur många frågor de har besvarat korrekt, antal sidor som är visade och deras aktuella betyg/omdöme.</li> <li><b>Slutet på lektionen</b> når de antingen genom att uttryckligen hoppa till den platsen eller genom att hoppa till nästa sida från den sista (logiska) sidan av lektionen. När de har nått slutet på lektionen så får de se ett gratulationsmeddelande och sitt betyg/omdöme. Betyget/omdömet är lika med (antal frågor som har besvarats korrekt/antal sidor som har visats) * betyget/omdömet för lektionen. </li> <li>Om slutet på lektionen <i>inte</i> är uppnått och studenten avbryter den någonstans inne i den, så får han/hon nästa gång då han/hon återupptar lektionen, möjlighet att välja om han/hon vill börja om från början eller om han/hon vill fortsätta där han/hon lämnade sitt senaste korrekta svar. </li> <li>När det gäller lektioner som man får göra om så kan    lkonstruktören välja om han/hon ska använda det bästa betyget eller medelbetyget för alla försök som det "slutliga" betyget/omdömet på lektionen. Det betyget/omdömet visas t ex på sidan för Betyg/omdömen.</li> <li>Klustersidor: ett kluster representerar en uppsättning frågor och det går att välja en eller eller flera frågor ur på den på ett slumpmässigt sätt. Kluster bör kompletteras med en sida för Slut på kluster för att det ska bli bästa möjliga resultat annars kommer de att hantera Slut på lektion som Slut på kluster. Frågor inom ett kluster väljs ut slumpmässigt genom att du ställer in "Slumpmässig fråga inom kluster" som ett hopp. Frågor inom ett kluster kan antingen länka till Slut på kluster eller hoppa till en inte-visad fråga inom klustret eller hoppa till vilken annan sida som helst i lektionen. Det här aktiverar även skapandet av scenarior med en slumpmässig komponent som använder modulen Lektion.</li> </ol>';
$string['page'] = 'Sida:  {$a}';
...
$string['rawgrade'] = 'Grovt antaget betyg';
...
$string['teacherjumpwarning'] = 'Det finns ett {$a->cluster} hopp eller ett {$a->unseen} hopp med i den här lektionen. Hoppet "Nästa sida" kommer att användas istället. Logga in som en student för att testa dessa hopp.';
...
$string['teachertimerwarning'] = 'Tidtagaren fungerar bara för studenter. Logga in som en sådan för att testa tidtagaren.';
...
$string['yourcurrentgradeisoutof'] = 'Ditt resultat är {$a->grade} av {$a->total}';
