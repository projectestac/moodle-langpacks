...
$string['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'] = 'Excelark';
...
$string['application/x-javascript'] = 'JavaScript-källa';
...
$string['group:html_audio'] = 'Ljudfiler med inbyggt webbläsarstöd';
$string['group:html_track'] = 'HTML track files';
$string['group:html_video'] = 'Videofiler med inbyggt stöd för webbläsare';
