...
$string['pinblocksexplan'] = 'Alla inställningar för block som du konfigurerar här kommer att vara synliga (och inte-redigerbara) för varje användare av Moodle på deras \'Mitt Moodle\' sida.';
$string['privacy:metadata:core_my:preference:user_home_page_preference'] = 'Användarens preferenser för hemsidan';
