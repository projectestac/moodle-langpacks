...
$string['plugincheckattention'] = 'Plugin som kräver uppmärksamhet';
$string['pluginchecknone'] = 'Inga plugin kräver din uppmärksamhet';
$string['pluginchecknotice'] = 'Denna sida visar plugins som kan kräva din uppmärksamhet under uppgraderingen som t.ex. nya plugins som behöver installeras, uppgraderas eller saknas. Övriga pluginsvvisas om det finns en tillgänglig uppdatering för dem. Det rekommenderas att du kontrollerar om det finns nyare versioner av plugins tillgängliga och uppdatera dem innan du fortsätter med denna Moodle uppgradering.';
