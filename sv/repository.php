...
$string['activerepository'] = 'Tillgängliga plugin-moduler för lagringsplats';
...
$string['addplugin'] = 'Lägg till plugin-modul för lagringsplats';
...
$string['invalidplugin'] = 'Ogiltig plugin-modul {$a} för lagringsplats';
...
$string['plugin'] = 'Plugin-moduler för lagringsplatser';
