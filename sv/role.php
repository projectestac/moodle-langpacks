...
$string['grade:manage'] = 'Hantera betygskomponenter';
...
$string['grade:manageoutcomes'] = 'Hantera resultat för betyg/omdömen';
$string['grade:managesharedforms'] = 'Hantera mallar för avancerade betygssättningsmetoder';
$string['grade:override'] = 'Åsidosätt betyg/omdömen';
...
$string['h5p:updatelibraries'] = 'Hantera innehållstyper gör H5P';
...
$string['managerdescription'] = 'Chefer kan komma åt kurser och ändra dem, men brukar inte delta i dem.';
...
$string['notabletoassignroleshere'] = 'Tilldelning av roller i den här kontexten har inte aktiverats av administratören.';
...
$string['roleallowinfo'] = 'Välj en roll att lägga till listan av tillåtna roller i kontext {$a->context}, förmåga {$a->cap}:';
