...
$string['modulename'] = 'Reflektionsenkät';
$string['modulename_help'] = 'Aktivitetsmodulen "Reflektionsenkät" (tidigare "Färdig enkät") erbjuder flera typer av verktyg för att genomföra utvärdering och stimulera lärande i uppkopplade miljöer. Lärare kan använda dem för att samla data som hjälper dem att lära känna sina klasser (grupper) och reflektera över sin pedagogiska ledning av läroprocesserna.';
...
$string['pluginname'] = 'Reflektionsenkät';
