...
$string['issuerloginpagename_help'] = 'Om det här namnet anges kommer det att användas på inloggningssidan i stället för tjänstnamnet ovan';
...
$string['issuerusein_help'] = 'OAuth 2-tjänster kan användas för vissa interna tjänster, på inloggningssidan eller båda, om det behövs';
