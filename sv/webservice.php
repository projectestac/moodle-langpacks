...
$string['erroroptionalparamarray'] = 'Parametern för webbtjänstbeskrivningen med namnet \'{$a}\' är av typen en- eller fler-struktursparameter. Den kan inte ställas in som <code>VALUE_OPTIONAL</code>. Kontrollera beskrivningen för webbtjänsten.';
...
$string['missingrequiredcapability'] = 'Funktionsbehörighet {$a} krävs.';
