...
$string['areasubmissionattachment'] = 'Bilagor till inlämningen';
$string['areasubmissioncontent'] = 'Inlämnade texter';
$string['assess'] = 'Bedöm';
$string['assessedexample'] = 'Utvärderad exempeluppgift';
$string['assessedsubmission'] = 'Inskickad uppgift som är bedömd';
$string['assessingexample'] = 'Bedömer inskickad exempeluppgift';
$string['assessingsubmission'] = 'Bedömer inskickad uppgift';
...
$string['assessmentend'] = 'Sluttid för bedömningar';
...
$string['assessmentsettings'] = 'Inställningar för bedömning';
$string['assessmentstart'] = 'Öppen för bedömning';
...
$string['clearassessments'] = 'Töm bedömningar och betygssättningar';
...
$string['createsubmission'] = 'Lämna in';
...
$string['editassessmentform'] = 'Redigera formulär för bedömning.';
$string['editassessmentformstrategy'] = 'Redigera bedömningsformulär ({$a})';
$string['editingassessmentform'] = 'Redigerar formulär för bedömning';
...
$string['exampleassessments'] = 'Exempeluppgifter för utvärdering';
...
$string['examplesubmissions'] = 'Exempel på inlämningar';
...
$string['feedbackreviewer'] = 'Återkoppling till bedömaren';
...
$string['gradeitemassessment'] = '{$a->workshopname} (bedömning/betygssättning)';
...
$string['instructreviewers'] = 'Instruktioner för bedömning';
...
$string['submissiondeleteconfirm'] = 'Är du säker på att du vill ta bort följande inskick?';
...
$string['userplancurrentphase'] = 'Fas';
