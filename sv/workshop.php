...
$string['allocate'] = 'Tilldela inlämningar';
...
$string['allowedfiletypesforsubmission'] = 'Tillåtna filtyper för återkopplingsbilagor';
$string['allowedfiletypesforsubmission_help'] = 'Filtyper för inlämningsbilagor kan begränsas genom att ange en lista över tillåtna filtyper. Om fältet lämnas tomt är alla filtyper tillåtna.';
...
$string['backtoeditform'] = 'Tillbaka till formulärredigeringen';
...
$string['eventassessmentevaluated'] = 'Bedömning gjord';
$string['eventassessmentevaluationsreset'] = 'Nollställ bedömningar';
$string['eventassessmentreevaluated'] = 'Bedömning gjord på nytt';
