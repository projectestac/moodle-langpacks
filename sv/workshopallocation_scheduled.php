...
$string['pluginname'] = 'Schemalagd allokering';
...
$string['resultvoidexecuted'] = 'Allokeringen har redan genomförts';
$string['scheduledallocationsettings'] = 'Inställningar för schemalagd allokering';
$string['setup'] = 'Konfigurera schemalagd allokering';
