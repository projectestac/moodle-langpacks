...
$string['addnewattemptfromprevious'] = '根据上次提交添加新尝试';
...
$string['allowsubmissionsanddescriptionfromdatesummary'] = '作业细节和提交表单将从{$a}中获得';
...
$string['confirmsubmission'] = '您确定要把作业交上来评分吗?提交后，不可再进行任何更改。';
...
$string['duedatereached'] = '此作业的到期日期已经过了';
...
$string['graded'] = '评分';
$string['gradedby'] = '评分人';
$string['gradedfollowupsubmit'] = '评分 - 继续收到的提交';
$string['gradedon'] = '评分时间';
$string['gradelocked'] = '该成绩在成绩册中被锁定或覆盖。';
...
$string['groupsubmissionsettings'] = '小组提交设置';
...
*已公布：学生可以查看成绩和反馈';
$string['markingworkflowstateinmarking'] = '评分中';
$string['markingworkflowstateinreview'] = '检查中';
$string['markingworkflowstatenotmarked'] = '未评分';
$string['markingworkflowstatereadyforrelease'] = '准备公布';
$string['markingworkflowstatereadyforreview'] = '评分完成';
...
$string['multipleteams'] = '一个以上组的成员';
$string['multipleteams_desc'] = '作业要求小组提交。您是多个组的成员。为了能够提交, 您必须只是一个组的成员。请联系您的教师更改您的组成员身份。';
...
$string['nomoresubmissionsaccepted'] = '只适用于已获延期的参与者';
$string['none'] = '无';
$string['noonlinesubmissions'] = '这个作业不需要您在线提交任何东西';
$string['noopen'] = '无开放日期';
...
$string['noteam_desc'] = '此作业要求小组提交。您不是任何组的成员, 因此不能创建提交。请联系您的老师把您添加到一个小组中。';
...
$string['overdue'] = '<font color="red">逾期未交：{$a}</font>';
$string['override'] = '覆盖';
...
$string['submissioneditable'] = '学生可以编辑此提交';
...
$string['submissionnoteditable'] = '学生不能编辑此提交';
...
$string['submissionstatusheading'] = '提交状态';
$string['submissionstatus_marked'] = '评分';
$string['submissionstatus_new'] = '未提交';
$string['submissionstatus_reopened'] = '重新开始';
$string['submissionstatus_submitted'] = '提交了去评分';
...
$string['submitassignment_help'] = '提交作业后，您将不能再做任何更改。';
...
$string['ungroupedusers'] = '“要求小组提交”的设置启用，某些用户未分配小组或者加入多个小组，将不能完成作业。';
$string['ungroupedusersoptional'] = '“学生小组提交”的设置启用，有些用户不是任何组的成员，或者是多个组的成员。请注意，这些学生将作为“默认组”的成员提交。';
