...
$string['confirmeventseriesdelete'] = '“{$a->name}”事件是系列的一部分。您想要删除这个事件，还是要删除系列中的所有{$a->count}事件?';
$string['course'] = '课程';
...
$string['eventcalendareventdeleted'] = '日历事件删除';
...
$string['invalidtimedurationminutes'] = '您输入的持续时间(以分钟为单位)无效。请输入持续时间(以分钟为单位)，或选择不持续时间。';
$string['invalidtimedurationuntil'] = '您为“持续到”选择的时间和日期早于此事件的开始时间。请在继续处理前纠正这个错误。';
...
$string['repeateditall'] = '应用到此重复系列的其它{$a}事件';
