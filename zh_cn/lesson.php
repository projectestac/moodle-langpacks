...
$string['defaultessayresponse'] = '您的老师会对您的简答题评分。';
...
$string['displayofgrade'] = '成绩展示(只供学生使用)';
$string['displayreview'] = '提供重试一道题目的选项';
$string['displayreview_help'] = '如果启用，当学生未能正确回答问题时，可以选择再答一次但不计分，或者继续练习。';
$string['displayscorewithessays'] = '您在自动评分的题目中得分{$a->score}（满分:{$a->tempmaxgrade}）。<br />您的{$a->essayquestions}个问答题将晚些评分，并添加到您的最终成绩中。<br /><br />您当前不包含问答题的成绩是:{$a->score} （满分：{$a->grade}）';
$string['displayscorewithoutessays'] = '您的得分是{$a->score}(总分$a->grade})。';
...
$string['maximumnumberofattemptsreached'] = '达到最大尝试次数—请进入下一个页面';
...
$string['modattemptsnoteacher'] = '学生检查只对学生有效。';
...
$string['new'] = '新的';
$string['nextpage'] = '下一页';
$string['noanswer'] = '一个或多个问题没有给出答案。请返回并提交一个答案。';
...
$string['notitle'] = '没有标题';
$string['numberofcorrectanswers'] = '正确回答数量：{$a}';
...
$string['numberofpagesviewednotice'] = '回答问题数:{$a->nquestions};(您至少要回答{$a->minquestions})';
$string['numerical'] = '计算题';
$string['ongoing'] = '显示即时分数';
$string['ongoingcustom'] = '到目前为止，您已经从{$a->currenthigh}分中获得 {$a->score}分。';
...
$string['yourcurrentgradeisoutof'] = '您目前的成绩是{$a->grade}（总分{$a->total}）';
$string['youshouldview'] = '您至少应该回答:{$a}';
