...
$string['digitalminor_desc'] = '请家长/监护人联系：';
$string['directory'] = '字典';
$string['disable'] = '禁用';
...
$string['eventcommentcreated'] = '评论了';
$string['eventcommentdeleted'] = '删除评论';
...
$string['explanationdigitalminor'] = '需要这些信息来确定您的年龄是否达到了同意的数字年龄。在这个年龄，个人可以同意条款和条件，他们的数据被合法存储和处理。';
...
$string['passwordforgotteninstructions2'] = '要重设密码，请在下方提交您的用户名或电子邮件地址。如果我们能在数据库中找到您，我们将发送电子邮件到您的电子邮件地址，并说明如何再次访问。';
...
$string['policyagreement'] = '网站政策协议';
$string['policyagreementclick'] = '链接到网站政策协议';
$string['popup'] = '弹出';
...
$string['quotausage'] = '您已经使用了{$a->total}的{$a-> using}。';
...
$string['whyisthisrequired'] = '为什么需要这样做?';
